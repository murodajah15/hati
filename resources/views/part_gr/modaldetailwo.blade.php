...
<div class="modal-dialog" style="max-width: 70%;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    @if ($wo_gr->close == 1 or $wo_gr->close_part == 1)
                ...
                <div class="col-sm-6">
                    &nbsp;&nbsp;<button style="display:inline"
                        ...
                        onclick="reload_table_part_wo()" type="button"><i class="fa fa-spinner"></i></button>
                </div><!-- /.col -->
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl-partwo_gr" class="table table-bordered table-hover table-sm tbl-partwo_gr">
                        <thead>
                            <th>#</th>
                            <th>Kode</th>
                            <th>Nama</th>
...
<script>
    ...
    function reload_table_wo_part() {
        $(function() {
            ...
            // var vnowo = $("#nowo").val();
            var table = $('#tbl-partwo_gr').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        data: null,
                        render: function(data, type, row, meta) {
                            return `<a href="#${row.id}"><button onclick="editdetailpart(${row.id})" class='btn btn-sm btn-warning' href='javascript:void(0)' <?= $edit == 1 ? '' : 'disabled' ?> <?= $close_wo == 1 ? 'disabled' : '' ?> <?= $close_part == 1 ? 'disabled' : '' ?>><i class='fa fa-edit'></i></button></a>
                            <a href="#${row.id},${row.kode}"><button onclick="hapusdetailpart(${row.id})" class='btn btn-sm btn-danger' href='javascript:void(0)' <?= $hapus == 1 ? '' : 'disabled' ?> <?= $close_wo == 1 ? 'disabled' : '' ?> <?= $close_part == 1 ? 'disabled' : '' ?>><i class='fa fa-trash'></i></button></a>`;
