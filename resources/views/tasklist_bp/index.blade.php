...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-tasklist_bp" class="table table-bordered table-hover table-sm tbl-tasklist_bp">
                            {{-- <table id="tbl-tasklist_bp" class="table table-bordered table-striped tbl-tasklist_bp"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="70">Kode</th>
                                    <th width="350">Nama</th>
                                    <th width="350">Nama Alias</th>
                                    <th width="30">Panel</th>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-tasklist_bp').DataTable({
                    ajax: "{{ route('tasklist_bpajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                url: "<?= 'tabel_tasklist_bp' ?>",
                beforeSend: function(f) {
                    $('.btnreload').attr('disable', 'disabled')
                    $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
                    // alert('1');
                    $('#tabel_tasklist_bp').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_tasklist_bp').html(data);
