...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-jenis" class="table table-bordered table-hover table-sm tbl-jenis">
                            {{-- <table id="tbl-jenis" class="table table-bordered table-striped tbl-jenis"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-jenis').DataTable({
                    ajax: "{{ route('tbjenisajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_jenis').html('<center>Loading Table ...</center>');
                },
