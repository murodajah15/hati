...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-mobil" class="table table-bordered table-hover table-sm tbl-mobil">
                            {{-- <table id="tbl-mobil" class="table table-bordered table-striped tbl-mobil"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="50">No.Polisi</th>
                                    <th width="80">No.Rangka</th>
                                    <th width="50">No.Mesin</th>
                                    <th width="50">Tahun</th>
                                    <th width="50">Kd.Pemilik</th>
    ...
    <div class="modal fade" id="modaltambahcustomer" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-mobil').DataTable({
                    ajax: "{{ route('tbmobilajax') }}",
