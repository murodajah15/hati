                    ...
                    <div class='col-md-6'>
                        <table style=font-size:12px; class='table table-borderless table-sm table-hover'>
                            ...
                            <tr>
                                ...
                                <input type="hidden" class="form-control form-control-sm" name="kdmodele"
                                    id="kdmodele" value="<?= $tbmobil['kdmodel'] ?>">
                                <td>
                                    <select class="form-control form-control-sm" name='kdmodel' id="kdmodel"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'disabled' : '' }}>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <input type="hidden" class="form-control form-control-sm" name="kdtipee" id="kdtipee"
                                    value="<?= $tbmobil['kdtipe'] ?>">
                                <td>
                                    <select class="form-control form-control-sm" name='kdtipe' id="kdtipe"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'disabled' : '' }}>
                                    </select>
                                </td>
                            </tr>
