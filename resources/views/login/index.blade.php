        ...
        <div id="layoutAuthentication_content">
            <main>
                ...
                <div class="row h-100 justify-content-center align-items-center">
                    ...
                    <div class="card" style="width: 27rem; margin:15px">
                        ...
                        <div class='card-body'>
                            ...
                            <div class="col-lg-12">
                                ...
                                <h5 class='text-center'><img src="{{ url('assets/image/logo.png') }}" width='100'
                                        height='80' style='margin:-10px' class='img-circle'>
                                </h5>
                                {{-- <h3 class="text-center">
                                        Login <b>{{ config('app.name') }}</h3> --}}
                                <h3 class="text-center">
                                    Honda Autoland</h3>
                                <h5 class="text-center">Tekonologi Informasi</h5>
                                @if (session('error'))
