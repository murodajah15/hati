...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-jasa" class="table table-bordered table-hover table-sm tbl-jasa">
                            {{-- <table id="tbl-jasa" class="table table-bordered table-striped tbl-jasa"> --}}
                            <thead>
                                <tr>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                ...
                                <div id="tbl-jasa-jstree">
                                    <?php
                                    $jasaparent = DB::table('tbjasa')
                                        ->where('parent', 'Y')
                                        ->orderBy('kode')
                                        ->get();
                                    foreach ($jasaparent as $row) {
                                        echo '<ul>';
                                        echo '<li>';
                                        echo $row->kode . ' - ' . $row->nama;
                                        echo '<ul>';
                                        $kode = $row->kode;
                                        $jasachild = DB::table('tbjasa')
                                            ->where('parent_id', $kode)
                                            ->get();
                                        foreach ($jasachild as $rowd) {
                                            echo '<li>';
                                            echo $rowd->kode . ' - ' . $rowd->nama . ' - Jam : ' . $rowd->jam . ' - FRT : ' . $rowd->frt . ' - Harga : ' . $rowd->harga;
                                            echo '</li>';
                                        }
                                        echo '</ul>';
                                        echo '</li>';
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-jasa').DataTable({
                    ajax: "{{ route('tbjasaajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_jasa').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_jasa').html(data);
