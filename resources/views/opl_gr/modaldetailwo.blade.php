...
<div class="modal-dialog" style="max-width: 70%;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    @if ($wo_gr->close == 1 or $wo_gr->close_opl == 1 or $wo_gr->batal == 1)
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl-oplwo_gr" class="table table-bordered table-hover table-sm tbl-oplwo_gr">
                        <thead>
                            <th>#</th>
                            <th>Kode</th>
                            <th>Nama</th>
...
<script>
    ...
    function reload_table_opl_wo() {
        $(function() {
            ...
            // var vnowo = $("#nowo").val();
            var table = $('#tbl-oplwo_gr').DataTable({
