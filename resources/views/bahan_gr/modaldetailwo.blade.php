...
<div class="modal-dialog" style="max-width: 70%;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    @if ($wo_gr->close == 1 or $wo_gr->close_bahan == 1 or $wo_gr->batal == 1)
                        <button tipe="button" class="btn btn-primary btn-sm tomboltambahbahan" disabled> <i
                ...
                <div class="col-sm-6">
                    &nbsp;&nbsp;<button style="display:inline"
                        ...
                        onclick="reload_table_bahan_wo()" type="button"><i class="fa fa-spinner"></i></button>
                </div><!-- /.col -->
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl-bahanwo_gr" class="table table-bordered table-hover table-sm tbl-bahanwo_gr">
                        <thead>
                            <th>#</th>
                            <th>Kode</th>
                            <th>Nama</th>
...
<script>
    ...
    reload_table_bahan_wo();

    function reload_table_bahan_wo() {
        $(function() {
            let vnowo = document.getElementById('nowo').value;
            // var vnowo = $("#nowo").val();
            var table = $('#tbl-bahanwo_gr').DataTable({
