...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-leasing" class="table table-bordered table-hover table-sm tbl-leasing">
                            {{-- <table id="tbl-leasing" class="table table-bordered table-striped tbl-leasing"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-leasing').DataTable({
                    ajax: "{{ route('tbleasingajax') }}",
