                ...
                <div class='col-md-12'>
                    <table style=font-size:12px; class='table table-striped table table-bordered' width='600px'>
                        ...
                        <td><input type='text' class='form-control form-control-sm' style='width: 20em'
                                id='nmbarang' name='nmbarang' value="{{ $juald->nmbarang }}" readonly></td>
                        </td>
                        ...
                        @if ($kunci_harga_jual == 'Y')
                            <td><input type="text" class='form-control form-control-sm' id='harga'
                                    name='harga' style='width: 7em' value="{{ $juald->harga }}" readonly></td>
                        @else
                            <td><input type="text" class='form-control form-control-sm' id='harga'
                                    name='harga' style='width: 7em' onkeyup="validAngka_no_titik(this)"
                                    onblur="hit_subtotal()" value="{{ $juald->harga }}"></td>
                        @endif
                        ...
                        <td><input type="number" class='form-control form-control-sm' id='subtotal'
                                name='subtotal' style='width: 10em' value="{{ $juald->subtotal }}" readonly>
                        </td>
                    </table>
            </form>
            <div class="row">
