<div class="card-body">
    <form action="tbmobil_update" method="post" class="formfaktur_bp">
        <div class="row mt-2 mb-2">
            <?php
            $ftotal_jasa = number_format($faktur_bp->total_jasa, 0, ',', ',');
            $ftotal_part = number_format($faktur_bp->total_part, 0, ',', ',');
            $ftotal_bahan = number_format($faktur_bp->total_bahan, 0, ',', ',');
            $ftotal_opl = number_format($faktur_bp->total_opl, 0, ',', ',');
            $ftotal = number_format($faktur_bp->total, 0, ',', ',');
            $fdpp = number_format($faktur_bp->dpp, 0, ',', ',');
            $fpr_ppn = number_format($faktur_bp->pr_ppn, 0, ',', ',');
            $fppn = number_format($faktur_bp->ppn, 0, ',', ',');
            $ftotal_faktur = number_format($faktur_bp->total_faktur, 0, ',', ',');
            ?>
