...
$cetak = session('cetak');
$close_faktur = $faktur_bp->close;
$close_jasa = $faktur_bp->close_jasa;
$close_part = $faktur_bp->close_part;
$close_bahan = $faktur_bp->close_bahan;
$close_opl = $faktur_bp->close_opl;
$batal = $faktur_bp->batal;
?>
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] }}{{ ' ' . $faktur_bp->nopolisi . ' - ' . $faktur_bp->nofaktur }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control-sm" name="id_faktur_bp" id="id_faktur_bp"
                value="{{ $faktur_bp->id }}" readonly>
            <input type="hidden" class="form-control-sm" name="nofaktur_bp" id="nofaktur_bp"
                value="{{ $faktur_bp->nofaktur }}" readonly>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabjasa" disabled>
                    <div class="card-body">
                        {{-- <form action="" method="post" class="formfaktur_bp">
                            @csrf
                            @if ($faktur_bp->id)
                                @method('put')
                            @endif --}}
                        <div class="row">
                            @if ($faktur_bp->close == 1 or $faktur_bp->batal == 1)
                                <div class="col-md-12">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabpart">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblpart-faktur_bp" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabbahan">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblbahan-faktur_bp" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabopl">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblopl-faktur_bp" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
...
<script>
    ...
    function reload_table_faktur_jasa() {
        $(function() {
            let vnofaktur = document.getElementById('nofaktur_bp').value;
            // var vnofaktur = $("#nofaktur").val();
            var table = $('#tbljasa-faktur_bp').DataTable({
                ajax: "{{ url('jasafaktur_bpajax') }}?nofaktur=" + vnofaktur,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_faktur_part() {
        $(function() {
            let vnofaktur = document.getElementById('nofaktur_bp').value;
            // var vnofaktur = $("#nofaktur").val();
            var table = $('#tblpart-faktur_bp').DataTable({
                ajax: "{{ url('partfaktur_bpajax') }}?nofaktur=" + vnofaktur,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_faktur_bahan() {
        $(function() {
            let vnofaktur = document.getElementById('nofaktur_bp').value;
            // var vnofaktur = $("#nofaktur").val();
            var table = $('#tblbahan-faktur_bp').DataTable({
                ajax: "{{ url('bahanfaktur_bpajax') }}?nofaktur=" + vnofaktur,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_faktur_opl() {
        $(function() {
            let vnofaktur = document.getElementById('nofaktur_bp').value;
            // var vnofaktur = $("#nofaktur").val();
            var table = $('#tblopl-faktur_bp').DataTable({
                ajax: "{{ url('oplfaktur_bpajax') }}?nofaktur=" + vnofaktur,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_tab_faktur_summary() {
        $nofaktur = document.getElementById('nofaktur_bp').value;
        // alert($nofaktur)
        $.ajax({
            type: "get",
            data: {
