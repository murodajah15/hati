...
<div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
        ...
        <form action="{{ $action }}" method="post" class="formtambahbahan_bp">
            @csrf
            @if ($wo_bpd->id)
                @method('put')
            @endif
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group mb-1">
                                        ...
                                        <button class="btn btn-outline-secondary btn-sm" type="button" id="caribahan"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.formtambahbahan_bp').submit(function(e) {
            const form = $(this)
            e.preventDefault();
            $.ajax({
                type: "POST",
