...
@section('content')
    ...
    <script>
                            ...
                            render: function(data, type, row, meta) {
                                ...
                                return `<div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                <li><a class="dropdown-item <?= $pakai == 1 ? '' : 'disabled' ?>" onclick="estimasi_bp(${row.id})" href="#" readonly><i class='fa fa-book'"></i> Estimasi</a></li>
                                            </ul>
                                        </div>`;
        ...
        function estimasi_bp(id) {
            $.ajax({
                type: "get",
                url: `{{ url('vestimasi_bp') }}`,
                dataType: "json",
                data: {
                    id: id,
                    _method: "GET",
