                    ...
                    <div class="card-body">
                        ...
                        <font face="calibri">
                            <form method='post'>
                                ...
                                <div class="row">
                                    <div class='col-md-6'>
                                        <b>{{ 'Closing terakhir : ' . $saplikasi->closing_hpp }}</b>
                                        <input type="text" name="sedangproses" id="kdbarang"
                                            class="form-control-plaintext" value="Sedang Proses Closing ..."
                                ...
                                <div class="row">
                                    <div class='col-md-4'>
                                        ...
                                        <input button type='Button' class='btn btn-primary' value='Proses'
