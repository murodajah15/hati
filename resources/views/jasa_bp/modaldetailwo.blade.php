...
<div class="modal-dialog" style="max-width: 70%;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    @if ($wo_bp->close == 1 or $wo_bp->close_jasa == 1 or $wo_bp->batal == 1)
            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl-jasawo_bp" class="table table-bordered table-hover table-sm tbl-jasawo_bp">
                        <thead>
                            <th>#</th>
                            <th>Kode</th>
                            <th>Nama</th>
...
<script>
    ...
    function reload_table_jasa_wo() {
        $(function() {
            ...
            // var vnowo = $("#nowo").val();
            var table = $('#tbl-jasawo_bp').DataTable({
