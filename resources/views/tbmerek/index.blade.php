...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-merek" class="table table-bordered table-hover table-sm tbl-merek">
                            {{-- <table id="tbl-merek" class="table table-bordered table-striped tbl-merek"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-merek').DataTable({
                    ajax: "{{ route('tbmerekajax') }}",
