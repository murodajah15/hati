...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-cabang" class="table table-bordered table-hover table-sm tbl-cabang">
                            {{-- <table id="tbl-cabang" class="table table-bordered table-striped tbl-cabang"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-cabang').DataTable({
                    ajax: "{{ route('tbcabangajax') }}",
