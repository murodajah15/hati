                ...
                <div class='col-md-12'>
                    <table style=font-size:12px; class='table table-striped table table-bordered' width='600px'>
                        ...
                        <td><input type='text' class='form-control form-control-sm' style='width: 20em'
                                id='nmbarang' name='nmbarang' value="{{ $sod->nmbarang }}" readonly></td>
                        </td>
                        ...
                        @if ($kunci_harga_jual == 'Y')
                            <td><input type="text" class='form-control form-control-sm' id='harga' name='harga'
                                    style='width: 7em' value="{{ $sod->harga }}" readonly></td>
                        @else
                            <td><input type="text" class='form-control form-control-sm' id='harga' name='harga'
                        ...
                        <td><input type="number" class='form-control form-control-sm' id='subtotal'
                                name='subtotal' style='width: 10em' value="{{ $sod->subtotal }}" readonly></td>
                    </table>
            </form>
            <div class="row">
                <div class="col-md-12">
