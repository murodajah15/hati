...
<div class="modal-dialog" style="max-width: 70%;">
    <div class="modal-content">
        ...
        @endif --}}
        <form action="{{ $action }}" method="post" class="formtbsa">
            @csrf
            @if ($tbsa->id)
                @method('put')
            @endif
                            ...
                            <table style=font-size:12px; class='table table-borderless table-sm table-hover'>
                                <div class="col-md-6 mb-2">
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control form-control-sm" name="kode"
                                                style="width: 15em" id="kode" value="{{ $tbsa->kode }}"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"><input type="text" class="form-control form-control-sm"
                                                name="nama" id="nama" value="{{ $tbsa->nama }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3"><input type="text" class="form-control form-control-sm"
                                                name="alamat" id="alamat" value="{{ $tbsa->alamat }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td width="100">Kelurahan</td>
                                        <td colspan="3"><input type="text" class="form-control form-control-sm"
                                                name="kelurahan" id="kelurahan" value="{{ $tbsa->kelurahan }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td width="100">Kecamatan</td>
                                        <td colspan="3"><input type="text" class="form-control form-control-sm"
                                                name="kecamatan" id="kecamatan" value="{{ $tbsa->kecamatan }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}></td>
                                    </tr>
                                    <tr>
                                        <td width="50">Kode Pos</td>
                                        <td style="width:10em;"><input type="text"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:15em;"><input type="text"
                                                class="form-control form-control-sm" name="nohp" id="nohp"
                                                value="{{ $tbsa->nohp }}"
                                                {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="aktif"
                                                    name="aktif"
                                                    {{ (str_contains($vdata['title'], 'Tambah') ? 'checked' : $tbsa->aktif == 'Y') ? 'checked' : '' }}
                                ...
                                <tr>
                                    ...
                                    <td colspan=5> <input type='text' class='form-control form-control-sm'
                                            name='user' id='user' value="{{ $tbsa->user }}" readonly>
                                    </td>
                                </tr>
                                <?php } ?>
                            </table>
