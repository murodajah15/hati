...
<div class="modal-dialog" style="max-width: 85%;">
    <div class="modal-content">
        ...
        <form action="{{ $action }}" method="post" class="formsoh_bahan">
            @csrf
            @if ($soh_bahan->id)
                @method('put')
            @endif
            <?php $tgl = $saplikasi->tgl_berikutnya; ?>
            <input type="hidden" class="form-control-sm" name="id" id="id" value="{{ $soh_bahan->id }}">
            <input type="hidden" class="form-control-sm" name="username" id="username"
                value="{{ $session->get('username') }}">
            <input type="hidden" class="form-control-sm" name="nosolama" id="nosolama" value="{{ $soh_bahan->noso }}">
                        ...
                        <table style=font-size:12px; class='table table-borderless table-sm table-hover'>
                            <tr>
                                ...
                                <td>
                                    <input type='text' class='form-control form-control-sm' id='noso'
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 'SOB' . $saplikasi->tahun . sprintf('%02s', $saplikasi->bulan) . sprintf('%05s', $saplikasi->noso + 1) : $soh_bahan->noso }}"
                            ...
                            <tr>
                                ...
                                <td><input type='date' class='form-control form-control-sm' id='tglso'
                                        name='tglso'
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? $tgl : $soh_bahan->tglso }}"
                            ...
                            <tr>
                                ...
                                <td> <input type="text" class='form-control form-control-sm' id='nopo_customer'
                                        name='nopo_customer' autocomplete='off' value="{{ $soh_bahan->nopo_customer }}"
                            ...
                            <tr>
                                ...
                                <td> <input type="date" class='form-control form-control-sm' id='tglpo_customer'
                                        name='tglpo_customer' autocomplete='off'
                                        value="{{ $soh_bahan->tglpo_customer }}"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class='input-group'> <input type='text' class='form-control form-control-sm'
                                            ...
                                            value="{{ $soh_bahan->kdcustomer }}"
                                            {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                        <input type="text" class='form-control form-control-sm' style="width: 10em"
                                            id='nmcustomer' name='nmcustomer' value="{{ $soh_bahan->nmcustomer }}"
                                            readonly>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class='input-group'> <input type='text' class='form-control form-control-sm'
                                            ...
                                            value="{{ $soh_bahan->kdsales }}"
                                            {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                        <input type="text" class='form-control form-control-sm' style="width: 10em"
                                            id='nmsales' name='nmsales' value="{{ $soh_bahan->nmsales }}" readonly>
                                        <span class='input-group-btn'>
                                            <button type='button' id='src'
                            ...
                            {{-- <td><select required id='kdsales' name='kdsales' class='form-control form-control-sm'
                                ...
                                <td><input type='text' class='form-control form-control-sm' id='nmsales'
                                        name='nmsales' value="{{ $soh_bahan->nmsales }}" readonly></td> --}}
                            ...
                            <tr>
                                ...
                                <td> <input type="text" class='form-control form-control-sm' name='ket_biaya_lain'
                                        value="{{ $soh_bahan->ket_biaya_lain }}"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}> </td>
                            </tr>
                            <tr>
                                <td></td>
                        ...
                        <table style=font-size:12px; class='table table-borderless table-sm table-hover'>
                                ...
                                <td>
                                    ...
                                    <select class="form-control" name="carabayar" id="carabayar"
                                        ...
                                        for ($c = 0; $c < $jml_kata; $c += 1) {
                                            if ($arrcarabayar[$c] == $soh_bahan->carabayar) {
                            ...
                            <tr>
                                ...
                                <td> <input type="number" class='form-control form-control-sm'
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $soh_bahan->subtotal }}"
                                        readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <input type="number" class='form-control form-control-sm'
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $soh_bahan->total_sementara }}"
                                        readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <input type="number" style="text-align:right"
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $soh_bahan->ppn }}"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}> </td>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <input type="number" style="text-align:right"
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $soh_bahan->materai }}"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}> </td>
                            </tr>
                            <tr>
                                <td>Total</td>
                                <td> <input type="number" style="text-align:right"
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $soh_bahan->total }}"
                                        readonly></td>
                            </tr>
                            <tr>
                                <td>Keterangan</td>
                                <td>
                                    <textarea type='text' rows='2' class='form-control form-control-sm' id='kerangan' name='keterangan'
                                        autocomplete='off' {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>{{ $soh_bahan->keterangan }}</textarea>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" name="user"
                                            id="user" value="{{ $soh_bahan->user }}" readonly>
                                    </td>
                                </tr>
                            @endif
                        </table>
...
<script>
    ...
    function reload_table_detail_1() {
        $(function() {
            ...
            var table = $('#tbl-detail-so_1').DataTable({
                ajax: "{{ url('sod_bahanajax') }}?noso=" + vnoso,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    $(document).ready(function() {
        ...
        $('.formsoh_bahan').submit(function(e) {
            const form = $(this)
            e.preventDefault();
            $.ajax({
                type: "POST",
