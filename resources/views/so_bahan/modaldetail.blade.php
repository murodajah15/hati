    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' : ' . $soh_bahan->noso . ' - ' . $soh_bahan->kdcustomer . ' - ' . $soh_bahan->nmcustomer }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control-sm" name="nosod" id="nosod" value="{{ $soh_bahan->noso }}">
            {{-- <div class='col-md-12'> --}}
            <div class="row mb-0">
                <div class="col-sm-6">
                    <div class="btn-group">
