                    ...
                    <table style=font-size:12px; class='table table-striped table table-bordered' width='600px'>
                        ...
                        <td>
                            <div class='input-group'> <input type='text' class='form-control form-control-sm'
                                    ...
                                    size='50' autocomplete='off' value="{{ $belid->kdbarang }}">
                                <span class='input-group-btn'>
                        ...
                        @if ($kunci_harga_beli == 'Y')
                            <td><input type="text" class='form-control form-control-sm' id='harga'
                                    name='harga' style='width: 7em' value="{{ $belid->harga }}" readonly></td>
                        @else
                            <td><input type="text" class='form-control form-control-sm' id='harga'
                                    name='harga' style='width: 7em' onkeyup="validAngka_no_titik(this)"
                                    onblur="hit_subtotal()" value="{{ $belid->harga }}"></td>
                        @endif
                        ...
                        <td><input type="number" class='form-control form-control-sm' id='subtotal'
                                name='subtotal' style='width: 10em' value="{{ $belid->subtotal }}" readonly>
                        </td>
                    </table>
            </form>
            <div class="row">
