...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-asuransi" class="table table-bordered table-hover table-sm tbl-asuransi">
                            {{-- <table id="tbl-asuransi" class="table table-bordered table-striped tbl-asuransi"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-asuransi').DataTable({
                    ajax: "{{ route('tbasuransiajax') }}",
