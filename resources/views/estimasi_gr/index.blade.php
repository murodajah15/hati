...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-tbmobil_gr" class="table table-bordered table-hover table-sm tbl-tbmobil_gr">
                            {{-- <table id="tbl-mobil_gr" class="table table-bordered table-striped tbl-mobil_gr"> --}}
                            <thead>
                                <tr>
    ...
    <div class="modal fade" id="modaltambahestimasi" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
    ...
    <div class="modal fade" id="modaldetailestimasi" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-tbmobil_gr').DataTable({
                    ajax: "{{ route('tbmobil_grajax') }}",
                            ...
                            render: function(data, type, row, meta) {
                                ...
                                return `<div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                <li><a class="dropdown-item <?= $pakai == 1 ? '' : 'disabled' ?>" onclick="estimasi_gr(${row.id})" href="#" readonly><i class='fa fa-book'"></i> Estimasi</a></li>
                                            </ul>
                                        </div>`;
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_mobil_gr').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_mobil_gr').html(data);
        ...
        function estimasi_gr(id) {
            $.ajax({
                type: "get",
                url: `{{ url('vestimasi_gr') }}`,
                dataType: "json",
                data: {
                    id: id,
                    _method: "GET",
