...
$cetak = session('cetak');
$close_estimasi = $estimasi_gr->close;
?>
...
<div class="modal-dialog" style="max-width: 70%;">
    <div class="modal-content">
        ...
        @endif --}}
        {{-- <form action="updateestimasi_grd" method="post" class="formestimasi_grd">
            @csrf
            @if ($estimasi_gr->id)
                @method('get')
            @endif --}}
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control-sm" name="id_estimasi_gr" id="id_estimasi_gr"
                value="{{ $estimasi_gr->id }}" readonly>
            <input type="hidden" class="form-control-sm" name="noestimasi_gr" id="noestimasi_gr"
                value="{{ $estimasi_gr->noestimasi }}" readonly>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabjasa">
                    <div class="card-body">
                        {{-- <form action="" method="post" class="formestimasi_gr">
                            @csrf
                            @if ($estimasi_gr->id)
                                @method('put')
                            @endif --}}
                        <div class="row">
                            @if ($estimasi_gr->close == 1)
                                <div class="col-md-12">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabpart">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblpart-estimasi_gr" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabbahan">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblbahan-estimasi_gr" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabopl">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblopl-estimasi_gr" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
...
<script>
    ...
    function reload_table_estimasi_jasa() {
        $(function() {
            let vnoestimasi = document.getElementById('noestimasi_gr').value;
            // var vnoestimasi = $("#noestimasi").val();
            var table = $('#tbljasa-estimasi_gr').DataTable({
                ajax: "{{ url('tbljasa_estimasi_grajax') }}?noestimasi=" + vnoestimasi,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_estimasi_part() {
        $(function() {
            let vnoestimasi = document.getElementById('noestimasi_gr').value;
            // var vnoestimasi = $("#noestimasi").val();
            var table = $('#tblpart-estimasi_gr').DataTable({
                ajax: "{{ url('tblpart_estimasi_grajax') }}?noestimasi=" + vnoestimasi,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_estimasi_bahan() {
        $(function() {
            let vnoestimasi = document.getElementById('noestimasi_gr').value;
            // var vnoestimasi = $("#noestimasi").val();
            var table = $('#tblbahan-estimasi_gr').DataTable({
                ajax: "{{ url('tblbahan_estimasi_grajax') }}?noestimasi=" + vnoestimasi,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_estimasi_opl() {
        $(function() {
            let vnoestimasi = document.getElementById('noestimasi_gr').value;
            // var vnoestimasi = $("#noestimasi").val();
            var table = $('#tblopl-estimasi_gr').DataTable({
                ajax: "{{ url('tblopl_estimasi_grajax') }}?noestimasi=" + vnoestimasi,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_tab_estimasi_summary() {
        $noestimasi = document.getElementById('noestimasi_gr').value;
        // alert($noestimasi)
        $.ajax({
            type: "get",
            data: {
