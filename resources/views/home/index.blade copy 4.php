...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            <div class="image mt-0">
                ...
                <img src="{{ asset('storage/' . Session::get('photo', 'default')) }}" class="img-circle elevation-2" width="25" height="25" alt="User Image">
                {{-- <span class="badge badge-warning navbar-badge">{{ Auth::user()->nama_lengkap }}</span> --}}
                {{-- <span><label>&nbsp;{{ session('username') }}&nbsp;{{ '(' . Auth::user()->email . ')' }}</label><i class="caret"></i></span> --}}
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href={{ url('home') }} class="brand-link">
            <img src="{{ url('assets/image/logo.png') }}" {{-- class="brand-image img-circle elevation-3" style="opacity: .5"> --}} class="brand-image img-rounded elevation-2" style="opacity: .5">
            {{-- <span class="brand-text font-weight-light">Honda Autoland Group</span> --}}
            <span class="brand-text font-weight-light" style="color:whitesmoke;font-size:20px">{{ env('APP_NAME') }}</span>
            {{-- Point Of Sales --}}
        </a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column nav-compact" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    ?>
                                ...
                                <li class="nav-item has-treeview">
                                    <i class="nav-item {{ strtoupper($row['cmenu']) == strtoupper($submenu1) ? 'menu-open' : '' }} ">
                                        <a href="#" class="nav-link">
                                            <p>
                        ...
                        ?>
                        {{-- @if ($cparent == $row['cmodule'] and $record > 0)
                        </li>
                        @endif --}}
    ...
    <div class="modal fade" id="modalcontact" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    </div>
