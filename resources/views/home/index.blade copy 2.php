                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column nav-compact" data-widget="treeview" role="menu"
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                <li {{-- class="nav-item has-treeview {{ strtoupper($menu) == strtoupper($cmainmenu) ? 'menu-open' : '' }} "> --}} {{-- class="nav-item has-treeview {{ strtoupper($row['cmenu']) == strtoupper($submenu1) ? 'menu-open' : '' }} "> --}}
                                    class="nav-item has-treeview {{ strtoupper($row['cmenu']) == strtoupper($submenu1) ? 'menu-open' : '' }} ">
                                    <a href="#" class="nav-link">
                                        <p>
                                            {{-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $row['cmodule'] }} --}}
                                            {{-- &nbsp;&nbsp;<i
                                        class="fas fa-angle-right left"></i>&nbsp;&nbsp;{{ $row['cmodule'] }} --}}
                                            <i class="far fa-circle nav-icon"></i>{{ $row['cmodule'] }}
