...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-sa" class="table table-bordered table-hover table-sm tbl-sa">
                            {{-- <table id="tbl-sa" class="table table-bordered table-striped tbl-sa"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-sa').DataTable({
                    ajax: "{{ route('tbmekanikajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_sa').html('<center>Loading Table ...</center>');
                },
