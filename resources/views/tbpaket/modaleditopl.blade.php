...
<div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
        ...
        @endif --}}
        <form action="updatepaketopl" method="post" class="formtbpaket_detail">
            @csrf
            ...
            <div class="modal-body">
                ...
                <input type="hidden" class="form-control-sm" name="jenis" jenis="jenis" value="opl">
                <input type="hidden" class="form-control-sm" name="kodelama" id="kodelama"
                    value="{{ $tbpaket_detail->kdpaket }}">
                <div class="col-md-12 mb-2">
                    <label for="kode" class="form-label mb-1">Kode OPL</label>
                    <input type="text" class="form-control" name="kodeopl" id="kodeopl"
                        value="{{ $tbpaket_detail->kode }}" readonly>
                    <label for="nama" class="form-label mb-1">Nama OPL</label>
                    <input type="text" class="form-control" name="namaopl" id="namaopl"
                    ...
                    <input type="number" class="form-control" name="qtyopl" id="qtyopl" style="text-align:right;"
