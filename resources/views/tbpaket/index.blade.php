...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-paket" class="table table-bordered table-hover table-sm tbl-paket">
                            {{-- <table id="tbl-paket" class="table table-bordered table-striped tbl-paket"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-paket').DataTable({
                    ajax: "{{ route('tbpaketajax') }}",
