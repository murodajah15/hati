...
<div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
        ...
        @endif --}}
        <form action="updatepaketjasa" method="post" class="formtbpaket_detail">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" name="kodejasa" id="kodejasa"
                        value="{{ $tbpaket_detail->kode }}" readonly>
                    <label for="nama" class="form-label mb-1">Nama Jasa</label>
                    <input type="text" class="form-control" name="namajasa" id="namajasa"
                        value="{{ $tbpaket_detail->nama }}"
