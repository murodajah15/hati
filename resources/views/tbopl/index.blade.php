...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-opl" class="table table-bordered table-hover table-sm tbl-opl">
                            {{-- <table id="tbl-opl" class="table table-bordered table-striped tbl-opl"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-opl').DataTable({
                    ajax: "{{ route('tboplajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_opl').html('<center>Loading Table ...</center>');
                },
