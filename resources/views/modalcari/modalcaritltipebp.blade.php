            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <table id="tblcaritltipebp" class="table table-bordered table-hover table-sm">
                            <thead>
                                <tr>
                                    <th width="5">No</th>
                                    <th width="70">Kode</th>
                                    <th width="350">Nama</th>
                                    <th width="100">Asuransi</th>
                                    <th width="400"></th>
                                </tr>
                            </thead>
                            <tbody id="isi_data" class="isi_data">
                                ...
                                @foreach ($tasklist_bp as $row)
                                    ...
                                    <tr id="tr" style="cursor: pointer; ">
                                        ...
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbtltipebp();">
                                            {{ $row->kode }}</td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbtltipebp();">
                                            {{ $row->nama }}</td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbtltipebp();">
...
<script>
    ...
    function post_data_tbtltipebp() {
        var table = document.getElementById("tblcaritltipebp");
        ...
        tbody.onclick = function(e) {
            ...
            $('#modalcaritltipebp').modal('hide');
            $('#modaldetail').modal('show');
            $('#kdtasklist_salin').focus();
        };
    }
</script>
