            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <table id="tblcariopl" class="table table-bordered table-hover table-sm">
                            <thead>
                                <tr>
                                    <th width="5">No</th>
                                    <th width="70">Kode</th>
                            ...
                            <tbody id="isi_data" class="isi_data">
                                ...
                                @foreach ($tbopl as $row)
                                    ...
                                    <tr id="tr" style="cursor: pointer; ">
                                        ...
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbopl();">
                                            {{ $row->kode }}</td>
                                        <td id="td" data-bs-dismiss="modal" onclick="post_data_tbopl();">
                                            {{ $row->nama }}</td>
                                        <td style="text-align:right;" id="td" data-bs-dismiss="modal"
                                            onclick="post_data_tbopl();">
                                            {{ $row->harga_jual }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
...
<script>
    ...
    function post_data_tbopl() {
        ...
        tbody.onclick = function(e) {
            ...
            // $('#qtyopl').val(((dt_split[3]).replace("--separator--", "")).trim());
            $('#modalcariopl').modal('hide');
            $('#modaltambahopl').modal('show');
            $('#kode').focus();
        };
    }
</script>
