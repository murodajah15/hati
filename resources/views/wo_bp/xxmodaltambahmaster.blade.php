        ...
        <div class="modal-body">
            ...
            <form action={{ $action }} method="post" class="formtambahwo">
                ...
                @if ($wo_bp->id)
                    @method('put')
                @endif
                <input type="hidden" class="form-control form-control-sm" name="idwo" id="idwo"
                    value="<?= $wo_bp['id'] ?>">
                <div class="row mb-2 mt-0">
                    <div class="col-12 col-sm-6">
                        ...
                        ?>
                        <label for="nama" class="form-label mb-1">{{ $action }}No. WO / Tanggal/ Est Selesai
                            (M-D-Y)</label>
                        ...
                        <div class="input-group mb-1">
                            <input type='text' class='form-control form-control-sm mb-2'
                                ...
                                style="width: 5%" id='nowo'
                                name={{ str_contains($vdata['title'], 'Edit') ? 'nowo' : '' }} readonly>
                            <input type="datetime-local" class='form-control form-control-sm mb-2' name='tanggal'
                                id='tanggal' value="<?= $wo_bp->tglwo ?>" style="width: 40%" readonly>
                        </div>
                        <label for="nama" class="form-label mb-1">{{ $action }}No. Estimasi / Tanggal
                            (M-D-Y)</label>
                        <div class="input-group mb-1">
                            <input type='text' class='form-control form-control-sm mb-2'
                                value="{{ str_contains($vdata['title'], 'Tambah') ? 'AUTO GENERATE' : $wo_bp->nowo }}"
                                style="width: 5%" id='noestimasi'
                                name={{ str_contains($vdata['title'], 'Edit') ? 'noestimasi' : '' }} readonly>
                            <input type="datetime-local" class='form-control form-control-sm mb-2' name='tanggal'
                                id='tanggal' value="<?= $wo_bp->tglestimasi ?>" style="width: 40%" readonly>
                        </div>
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="km"
                                placeholder="KM" value="<?= $wo_bp['km'] ?>"
