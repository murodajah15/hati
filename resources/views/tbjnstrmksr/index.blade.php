...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-jnstrmksr" class="table table-bordered table-hover table-sm tbl-jnstrmksr">
                            {{-- <table id="tbl-jnstrmksr" class="table table-bordered table-striped tbl-jnstrmksr"> --}}
                            <thead>
                                <tr>
                                    <th width=30 style="text-align:center;">#</th>
                                    <th width="50">Kode</th>
                                    <th width="450">Nama</th>
                                    <th width="150">Kode Acc</th>
                                    <th width="10">Aktif</th>
                                    <th width="90">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                {{-- @foreach ($tbjnstrmksr as $row)
                                    <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-jnstrmksr').DataTable({
                    ajax: "{{ route('tbjnstrmksrajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_jnstrmksr').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_jnstrmksr').html(data);
