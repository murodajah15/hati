    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' Detail : ' . $poh_bahan->nopo }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            <form action="{{ $action }}" method="post" class="formeditdetail">
                ...
                <input type="hidden" class="form-control-sm" name="nopo" id="nopo"
                    value="{{ $poh_bahan->nopo }}">
                <input type="hidden" class="form-control-sm" name="nopod" id="nopod"
                    value="{{ $pod_bahan->nopo }}">
                <div class='col-md-12'>
                    <table style=font-size:12px; class='table table-striped table table-bordered' width='600px'>
                        ...
                        <td>
                            <div class='input-group'> <input type='text' class='form-control form-control-sm'
                                    ...
                                    size='50' autocomplete='off' value="{{ $pod_bahan->kdbarang }}">
                                <span class='input-group-btn'>
                                    &nbsp<button type='button' id='srctb' class='btn btn-success btn-sm'
                                        onclick='caritbbahan()'>TB</button>
                                </span>
                        </td>
                        <input type="hidden" id="kdsatuan" name="kdsatuan" value="{{ $pod_bahan->kdsatuan }}">
                        </td>
                        <td><input type='text' class='form-control form-control-sm' style='width: 20em'
                                id='nmbarang' name='nmbarang' value="{{ $pod_bahan->nmbarang }}" readonly></td>
                        </td>
