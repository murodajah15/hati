    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">
                {{ $vdata['title'] . ' : ' . $poh_bahan->nopo . ' - ' . $poh_bahan->kdsupplier . ' - ' . $poh_bahan->nmsupplier }}
                {{-- @if (isset($vdata))
                    {{ $vdata['title'] }}
                @endif --}}
            </h5>
        ...
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control-sm" name="nopod" id="nopod" value="{{ $poh_bahan->nopo }}">
            {{-- <div class='col-md-12'> --}}
            <div class="row mb-0">
                <div class="col-sm-6">
                    <div class="btn-group">
    ...
    function reload_table_detail() {
        $(function() {
            ...
            var table = $('#tbl-detail-po').DataTable({
                ajax: "{{ url('pod_bahanajax') }}?nopo=" + vnopo,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
