...
$nopo = $poh_bahan->nopo;
$tanggal = date('-d-m-Y', strtotime($poh_bahan->tglpo)); // $de['tglpo'];
$kdsupplier = $poh_bahan->kdsupplier;
$nmsupplier = $poh_bahan->nmsupplier;
$biaya_lain = number_format($poh_bahan->biaya_lain, 0, ',', '.');
$ppn = $poh_bahan->ppn;
$total = $poh_bahan->total;
$supplier = $poh_bahan->kdsupplier . '-' . $poh_bahan->nmsupplier;
$keterangan = $poh_bahan->keterangan;
$alamatcust = $poh_bahan->alamat . ' ' . $poh_bahan->kota . ' ' . $poh_bahan->kodepos;
$telpcust = $poh_bahan->telp1 . ' - ' . $poh_bahan->telp2;
...
$html .=
    ...
    '' .
    '</td>
			<td width="180" style="font-size:16px";>' .
    'Pemesan :' .
    ...
    "$nmsupplier" .
    '</td><td width="10"></td><td width="250" style="font-size:16px";>' .
    "$nm_perusahaan" .
    '</td>
			<tr><td width="350" style="font-size:14px";>' .
    "$alamatcust" .
    '</td><td width="10"></td><td width="550" style="font-size:14px";>' .
    "$alamat_perusahaan" .
    '</td>
			<tr><td width="250" style="font-size:14px";>' .
    "$telpcust" .
    '</td><td width="10"></td><td width="600" style="font-size:14px";>' .
    "$telp_perusahaan" .
    '</td>
			<tr><td width="250" style="font-size:12px";>' .
    '' .
    '</td><td width="10"></td><td width="250" style="font-size:16px";>No. PO : ' .
    "$nopo" .
    '</td>
			<tr><td width="250" style="font-size:12px";>' .
    '' .
    '</td><td width="10"></td><td width="250" style="font-size:14px";>Tanggal: ' .
    "$tanggal" .
    '</td>
		</table>
