...
<div class="modal-dialog" style="max-width: 85%;">
    <div class="modal-content">
        ...
        <form action="{{ $action }}" method="post" class="formpo">
            ...
            <input type="hidden" class="form-control-sm" name="id" id="id" value="{{ $poh_bahan->id }}">
            <input type="hidden" class="form-control-sm" name="username" id="username"
                value="{{ $session->get('username') }}">
            <input type="hidden" class="form-control-sm" name="nopolama" id="nopolama" value="{{ $poh_bahan->nopo }}">
                        ...
                        <table style=font-size:12px; class='table table-borderless table-sm table-hover'>
                            <tr>
                                ...
                                <td>
                                    <input type='text' class='form-control form-control-sm' id='nopo'
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 'POB' . $saplikasi->tahun . sprintf('%02s', $saplikasi->bulan) . sprintf('%05s', $saplikasi->nopo + 1) : $poh_bahan->nopo }}"
                            ...
                            <tr>
                                ...
                                <td><input type='date' class='form-control form-control-sm' id='tglpo'
                                        name='tglpo'
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? $tgl : $poh_bahan->tglpo }}"
                            ...
                            {{-- <tr>
                                ...
                                <td>
                                    <div class='input-group'> <input type='text' class='form-control form-control-sm'
                                            ...
                                            value="{{ $poh_bahan->kdsales }}"
                                            {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>
                                        <input type="text" class='form-control form-control-sm' style="width: 10em"
                                            id='nmsales' name='nmsales' value="{{ $poh_bahan->nmsales }}" readonly>
                                        <span class='input-group-btn'>
                                            <button type='button' id='src'
                            ...
                            <tr>
                                ...
                                <td> <input type="text" class='form-control form-control-sm' name='ket_biaya_lain'
                                        value="{{ $poh_bahan->ket_biaya_lain }}"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}> </td>
                            </tr>
                            <tr>
                                <td></td>
                        ...
                        <table style=font-size:12px; class='table table-borderless table-sm table-hover'>
                                ...
                                <td>
                                    ...
                                    <select class="form-control" name="carabayar" id="carabayar"
                                        ...
                                        for ($c = 0; $c < $jml_kata; $c += 1) {
                                            if ($arrcarabayar[$c] == $poh_bahan->carabayar) {
                            ...
                            <tr>
                                ...
                                <td> <input type="number" class='form-control form-control-sm'
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $poh_bahan->subtotal }}"
                                        readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <input type="number" class='form-control form-control-sm'
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $poh_bahan->total_sementara }}"
                                        readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <input type="number" style="text-align:right"
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $poh_bahan->ppn }}"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}> </td>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td> <input type="number" style="text-align:right"
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $poh_bahan->materai }}"
                                        {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}> </td>
                            </tr>
                            <tr>
                                <td>Total</td>
                                <td> <input type="number" style="text-align:right"
                                        ...
                                        value="{{ str_contains($vdata['title'], 'Tambah') ? 0 : $poh_bahan->total }}"
                                        readonly></td>
                            </tr>
                            <tr>
                                <td>Keterangan</td>
                                <td>
                                    <textarea type='text' rows='2' class='form-control form-control-sm' id='kerangan' name='keterangan'
                                        autocomplete='off' {{ str_contains($vdata['title'], 'Detail') ? 'readonly' : '' }}>{{ $poh_bahan->keterangan }}</textarea>
                                </td>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control form-control-sm" name="user"
                                            id="user" value="{{ $poh_bahan->user }}" readonly>
                                    </td>
                                </tr>
                            @endif
                        </table>
