...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-klpjasa" class="table table-bordered table-hover table-sm tbl-klpjasa">
                            {{-- <table id="tbl-klpjasa" class="table table-bordered table-striped tbl-klpjasa"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-klpjasa').DataTable({
                    ajax: "{{ route('tbklpjasaajax') }}",
        ...
        function reload_table1() {
            ...
            $.ajax({
                ...
                beforeSend: function(f) {
                    ...
                    // alert('1');
                    $('#tabel_klpjasa').html('<center>Loading Table ...</center>');
                },
                success: function(data) {
                    // alert(data);
                    $('#tabel_klpjasa').html(data);
