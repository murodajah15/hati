...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <table id="tbl-agama" class="table table-bordered table-hover table-sm tbl-agama">
                            {{-- <table id="tbl-agama" class="table table-bordered table-striped tbl-agama"> --}}
                            <thead>
                                <tr>
    ...
    <script>
        ...
        function reload_table() {
            ...
            $(function() {
                var table = $('.tbl-agama').DataTable({
                    ajax: "{{ route('tbagamaajax') }}",
