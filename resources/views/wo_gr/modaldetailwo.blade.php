...
$close_part = $wo_gr->close_part;
$close_bahan = $wo_gr->close_bahan;
$close_opl = $wo_gr->close_opl;
$batal = $wo_gr->batal;
?>
...
<div class="modal-dialog" style="max-width: 70%;">
    <div class="modal-content">
        ...
        @endif --}}
        {{-- <form action="updatewo_grd" method="post" class="formwo_grd">
            @csrf
            @if ($wo_gr->id)
                @method('get')
            @endif --}}
        <div class="modal-body">
            ...
            <input type="hidden" class="form-control-sm" name="id_wo_gr" id="id_wo_gr" value="{{ $wo_gr->id }}"
                readonly>
            <input type="hidden" class="form-control-sm" name="nowo_gr" id="nowo_gr" value="{{ $wo_gr->nowo }}"
                readonly>
            <input type="hidden" class="form-control" name="nowo" id="nowo" style="width:10em;"
                value="{{ $wo_gr->nowo }}" readonly>
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabjasa" disabled>
                    <div class="card-body">
                        {{-- <form action="" method="post" class="formwo_gr">
                            @csrf
                            @if ($wo_gr->id)
                                @method('put')
                            @endif --}}
                        <div class="row">
                            @if ($wo_gr->close == 1 or $wo_gr->batal == 1)
                                <div class="col-md-12">
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabpart">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblpart-wo_gr" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabbahan">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblbahan-wo_gr" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tabopl">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="tblopl-wo_gr" class="table table-bordered table-hover table-sm">
                                    <thead>
                                        <th>#</th>
                                        <th>Kode</th>
                                        <th>Nama</th>
...
<script>
    ...
    function reload_table_wo_jasa() {
        $(function() {
            let vnowo = document.getElementById('nowo_gr').value;
            // var vnowo = $("#nowo").val();
            var table = $('#tbljasa-wo_gr').DataTable({
    ...
    function reload_table_wo_part() {
        $(function() {
            let vnowo = document.getElementById('nowo_gr').value;
            // var vnowo = $("#nowo").val();
            var table = $('#tblpart-wo_gr').DataTable({
                ajax: "{{ url('partwo_grajax') }}?nowo=" + vnowo,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_wo_bahan() {
        $(function() {
            let vnowo = document.getElementById('nowo_gr').value;
            // var vnowo = $("#nowo").val();
            var table = $('#tblbahan-wo_gr').DataTable({
                ajax: "{{ url('bahanwo_grajax') }}?nowo=" + vnowo,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_table_wo_opl() {
        $(function() {
            let vnowo = document.getElementById('nowo_gr').value;
            // var vnowo = $("#nowo").val();
            var table = $('#tblopl-wo_gr').DataTable({
                ajax: "{{ url('oplwo_grajax') }}?nowo=" + vnowo,
                type: "GET",
                destroy: true,
                processing: true,
                serverSide: true,
    ...
    function reload_tab_wo_summary() {
        $nowo = document.getElementById('nowo_gr').value;
        // alert($nowo)
        $.ajax({
            type: "get",
            data: {
