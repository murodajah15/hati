...
$routes->post('po_part/input_po_partd', 'Po_part::input_po_partd');
$routes->get('/po_part/caridatapart', 'Po_part::caridatapart');
$routes->post('/po_part/replpart', 'Po_part::replpart');
$routes->post('/po_part/simpan_po_partd', 'Po_part::simpan_po_partd');
$routes->post('/po_part/table_po_partd', 'Po_part::table_po_partd');
$routes->post('/po_part/hitung_summary_po', 'Po_part::hitung_summary_po');
$routes->post('/po_part/tampil_detail_po_partd/(:num)', 'Po_part::tampil_detail_po_partd/$1');
$routes->post('/po_part/hapus_po_partd', 'Po_part::hapus_po_partd');
...
$routes->get('/beli_part', 'Beli_part::index');
$routes->post('/beli_part/ajax-load-data', 'Beli_part::ajaxLoadData');
$routes->get('/beli_part/table_beli_part', 'Beli_part::table_beli_part');
$routes->post('/beli_part/formdetail', 'Beli_part::formdetail');
$routes->get('/beli_part/formtambah', 'Beli_part::formtambah');
$routes->get('/beli_part/caridatapo', 'Beli_part::caridatapo');
$routes->post('/beli_part/replpo', 'Beli_part::replpo');
$routes->get('/beli_part/caridatasupplier', 'Beli_part::caridatasupplier');
$routes->post('/beli_part/replsupplier', 'Beli_part::replsupplier');
$routes->post('/beli_part/simpanbeli_part', 'Beli_part::simpanbeli_part');
$routes->post('/beli_part/formedit', 'Beli_part::formedit');
$routes->post('/beli_part/update_beli_part', 'Beli_part::update_beli_part');
$routes->post('/beli_part/hapus_beli_part', 'Beli_part::hapus_beli_part');
$routes->post('beli_part/input_beli_partd', 'Beli_part::input_beli_partd');
$routes->get('/beli_part/caridatapart', 'Beli_part::caridatapart');
$routes->post('/beli_part/replpart', 'Beli_part::replpart');
$routes->post('/beli_part/simpan_beli_partd', 'Beli_part::simpan_beli_partd');
$routes->post('/beli_part/table_beli_partd', 'Beli_part::table_beli_partd');
$routes->post('/beli_part/hitung_summary_po', 'Beli_part::hitung_summary_po');
$routes->post('/beli_part/tampil_detail_beli_partd/(:num)', 'Beli_part::tampil_detail_beli_partd/$1');
$routes->post('/beli_part/hapus_beli_partd', 'Beli_part::hapus_beli_partd');
$routes->post('/beli_part/close_beli_part', 'Beli_part::close_beli_part');
$routes->post('/beli_part/unclose_beli_part', 'Beli_part::unclose_beli_part');
$routes->get('beli_part/cetakbeli_part/(:num)', 'Beli_part::cetakbeli_part/$1');
$routes->post('beli_part/cancel_beli_part', 'Beli_part::cancel_beli_part');
