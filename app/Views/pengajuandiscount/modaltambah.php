...
<div class="modal fade" role="dialog" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 90%;">
    <div class="modal-content">
      ...
      <?= form_open('pengajuandiscount/simpandata', ['class' => 'formpengajuandiscount']) ?>
      <?php
      $nomemo = "WO" . uniqid();
      ?>
      <div class="modal-body">
        <div class="row mb-2">
          <div class="col-12 col-sm-6">
            ...
            <div class="col-12 col-sm-12">
              ...
              <div class="input-group mb-2">
                <input type="text" class="form-control" placeholder="No. Memo" name="nomemo" id="nomemo">
              ...
              <div class="col-md-12">
                <div class="input-group mb-2">
                  <input type="text" class="form-control" placeholder="Pemesan" name="kdcustomer" id="kdcustomer" readonly>
          ...
          <div class="col-12 col-sm-6">
            ...
            <input type="text" class="form-control mb-1" name="pembayaran" id="pembayaran" readonly>
            <div class="input-group">
              <div class="col-md-6">
                <label for="nama" class="form-label mb-0">Tipe</label>
                <input type="text" class="form-control mb-1" name="tipe" id="tipe" readonly>
              </div>
              <div class="col-md-6">
                <label for="nama" class="form-label mb-0">Warna</label>
                <input type="text" class="form-control mb-1" name="warna" id="warna" readonly>
              </div>
            </div>
            <label for="nama" class="form-label mb-1">Pembelian Accessories</label>
            <textarea rows=3 class='form-control mb-2' name='pembelian_accessories' id='pembelian_accessories'></textarea>
            ...
            <input type="text" style="text-align:right;" class='form-control mb-2' name='discount_team_harga' id='discount_team_harga' value='0'>
            <label for="nama" class="form-label mb-1">Discount Unit / Cash Back</label>
            <input type="text" style="text-align:right;" class='form-control mb-2' name='discount_cashback' id='discount_cashback' value='0'>
            <label for="nama" class="form-label mb-1">Paket</label>
            <input type="text" style="text-align:right;" class='form-control mb-2' name='paket' id='paket' value='0'>
            <label for="nama" class="form-label mb-1">Mediator</label>
            <input type="text" style="text-align:right;" class='form-control mb-2' name='mediator' id='mediator' value='0'>
            <label for="nama" class="form-label mb-1">Lain-Lain</label>
            <input type="text" style="text-align:right;" class='form-control mb-2' name='lain_lain' id='lain_lain' value='0'>
            <label for="nama" class="form-label mb-1">Bonus Accessories</label>
            <textarea rows=3 class='form-control mb-2' name='bonus_accessories' id='bonus_accessories'></textarea>
          </div>
