...
<div class="modal fade" id="modalapprov" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
      ...
      <?= form_open('pengajuandiscount/simpanapprov_dir', ['class' => 'formapprov_dir']) ?>
      ...
      <div class="modal-body">
        <div class="row mb-2">
          ...
          <div class="col-md-12">
            ...
            <select class="form-select mb-2" name="status_approv_dir" id="status_approv_dir">
              <option value="">[Pilih Persetujuan]
                <?php
                $arr = array("SETUJUI", "TIDAK DISETUJUI");
                $jml_kata = count($arr);
                for ($c = 0; $c < $jml_kata; $c += 1) {
                  if ($arr[$c] == $pengajuandiscount['status_approv_dir']) {
          ...
          <div class="col-md-12">
            ...
            <textarea rows="3" class='form-control form-control-sm mb-2' name='ket_approv_dir' id='ket_approv_dir'><?= $pengajuandiscount['ket_approv_dir'] ?></textarea>
          </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.formapprov_dir').submit(function(e) {
      e.preventDefault();
      $.ajax({
        type: "post",
