  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div id="tabel_pengajuandiscount"></div>
      </div>
    </div>
</main>
...
<div class="viewmodalpengajuandiscount" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('pengajuandiscount/table_pengajuandiscount'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_pengajuandiscount').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_pengajuandiscount').html(data);
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('pengajuandiscount/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('pengajuandiscount/modaldetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailpengajuandiscount($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('wo/detailpengajuandiscount') ?>",
      dataType: "json",
      data: {
        id: $id
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modaldetail_pengajuandiscount').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function hapus_pengajuandiscount($id, $kode) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/wo/";
          $.ajax({
            url: "<?php echo site_url('pengajuandiscount/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function detail_pengajuandiscount($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('pengajuandiscount/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit_pengajuandiscount($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('pengajuandiscount/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailpengajuandiscount($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailpengajuandiscount') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function modalpengajuandiscount($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('pengajuandiscount/modalpengajuandiscount') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modalpengajuandiscount').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function unproses_pengajuandiscount($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('pengajuandiscount/unproses') ?>/" + $id,
            data: {
              id: $id,
            },
            type: "POST",
