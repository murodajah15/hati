...
<div class="modal fade" id="modalapprov" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
      ...
      <?= form_open('pengajuandiscount/simpanapprov_spv', ['class' => 'formapprov_spv']) ?>
      ...
      <div class="modal-body">
        <div class="row mb-2">
          ...
          <div class="col-md-12">
            ...
            <select class="form-select mb-2" name="status_approv_spv" id="status_approv_spv">
              <option value="">[Pilih Persetujuan]
                <?php
                $arr = array("SETUJUI", "TIDAK DISETUJUI");
                $jml_kata = count($arr);
                for ($c = 0; $c < $jml_kata; $c += 1) {
                  if ($arr[$c] == $pengajuandiscount['status_approv_spv']) {
          ...
          <div class="col-md-12">
            ...
            <textarea rows="3" class='form-control form-control-sm mb-2' name='ket_approv_spv' id='ket_approv_spv'><?= $pengajuandiscount['ket_approv_spv'] ?></textarea>
          </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.formapprov_spv').submit(function(e) {
      e.preventDefault();
      $.ajax({
        type: "post",
