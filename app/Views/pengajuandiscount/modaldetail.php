      ...
      <div class="modal-body">
        <div class="row mb-2">
          ...
          <div class="col-12 col-sm-6">
            ...
            <div class="row">
              <?php
              if ($pengajuandiscount['valid'] == 'Y') {
                if ($session->get('level') == 'ADMINISTRATOR') {
                  if ($pengajuandiscount['status_approv_sm'] == '') {
              ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-warning btn-sm mb-2" onclick="approv_spv(<?= $pengajuandiscount['id'] ?>)">Approved SPV</button></div>
                    </div>
                  <?php
                  } else {
                  ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-warning btn-sm mb-2" onclick="approv_spv(<?= $pengajuandiscount['id'] ?>)" disabled>Approved SPV</button></div>
                    </div>
                  <?php
                  }
                  ?>
                  <?php
                  if ($pengajuandiscount['status_approv_spv'] == 'SETUJUI' and $pengajuandiscount['status_approv_dir'] == '') {
                  ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-info btn-sm mb-2" onclick="approv_sm(<?= $pengajuandiscount['id'] ?>)">Approved SM</button></div>
                    </div>
                  <?php
                  } else {
                  ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-info btn-sm mb-2" onclick="approv_sm(<?= $pengajuandiscount['id'] ?>)" disabled>Approved SM</button></div>
                    </div>
                  <?php
                  }
                  ?>
                  <?php
                  if ($pengajuandiscount['status_approv_sm'] == 'SETUJUI') {
                  ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-primary btn-sm mb-2" onclick="approv_dir(<?= $pengajuandiscount['id'] ?>)">Approved Direktur</button></div>
                    </div>
                  <?php
                  } else {
                  ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-primary btn-sm mb-2" onclick="approv_dir(<?= $pengajuandiscount['id'] ?>)" disabled>Approved Direktur</button></div>
                    </div>
                  <?php
                  }
                  ?>
                ...
                ?>
                  ...
                  ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-warning btn-sm mb-2" onclick="approv_spv(<?= $pengajuandiscount['id'] ?>)" <?= $session->get('kelompok') == 'SUPERVISOR' ? '' : 'disabled' ?>>Approved SPV</button></div>
                    </div>
                  <?php
                  } else {
                  ?>
                  ...
                  ?>
                  <?php
                  if ($pengajuandiscount['status_approv_dir'] == 'SETUJUI') {
                  ?>
                    <div class="col-12 col-sm-12">
                      <div class="d-grid"><button type="button" class="btn btn-info btn-sm mb-2" onclick="approv_sm(<?= $pengajuandiscount['id'] ?>)" <?= $session->get('kelompok') == 'MANAGER' ? '' : 'disabled' ?>>Approved SM</button></div>
                    </div>
                  <?php
                  } else {
                  ?>
                  ...
                  ?>
                    ...
                    ?>
                      <div class="col-12 col-sm-12">
                        <div class="d-grid"><button type="button" class="btn btn-primary btn-sm mb-2" onclick="approv_dir(<?= $pengajuandiscount['id'] ?>)" <?= $session->get('kelompok') == 'DIREKTUR' ? '' : 'disabled' ?>>Approved Direktur</button></div>
                      </div>
                    <?php
                    }
                    ?>
