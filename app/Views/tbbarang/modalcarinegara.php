              ...
              <tbody id="isi_data" class="isi_data">
                ...
                foreach ($tbnegara as $row) : ?>
                  <tr id="tr" style="cursor: pointer; ">
                    <td><?= $no; ?></td>
                    <td id="td" data-bs-dismiss="modal" onclick="post_data_tbnegara();"><?= $row['kode']; ?></td>
                    <td id="td" data-bs-dismiss="modal" onclick="post_data_tbnegara();"><?= $row['nama']; ?></td>
                  </tr>
                <?php $no++;
                endforeach; ?>
              </tbody>
