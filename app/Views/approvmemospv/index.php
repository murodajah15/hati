  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      <div class="card-header" style="height: 3rem;">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <div class="col-md-8">
              <div class="d-grid gap-4 d-md-flex justify-content-md-end">aaa
      ...
      <div class="card-body">
        ...
        <div id="tabel_approvmemospv"></div>
      </div>
    </div>
</main>
...
<div class="viewmodalapprovmemospv" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('approvmemospv/table_approvmemospv'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_approvmemospv').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_approvmemospv').html(data);
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('approvmemospv/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('approvmemospv/modaldetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailapprovmemospv($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('wo/detailapprovmemospv') ?>",
      dataType: "json",
      data: {
        id: $id
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modaldetail_approvmemospv').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function hapus_approvmemospv($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/wo/";
          $.ajax({
            url: "<?php echo site_url('approvmemospv/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function detail_approvmemospv($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('approvmemospv/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit_approvmemospv($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('approvmemospv/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailapprovmemospv($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailapprovmemospv') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function modalapprovmemospv($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('approvmemospv/modalapprovmemospv') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
  ...
  function proses_approvmemospv($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('approvmemospv/proses') ?>/" + $id,
            data: {
              id: $id,
            },
            type: "POST",
  ...
  function unproses_approvmemospv($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('approvmemospv/unproses') ?>/" + $id,
            data: {
              id: $id,
            },
            type: "POST",
  ...
  function cetak_approvmemospv($id) {
    // swal({
