...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <p style="margin-top:5px; font-size:18px; margin-bottom:5px;text-align:center;">
        <u>Form Faktur</u>
      </p>
      <table cellspacing="1" cellpadding="0" height="0">
        ...
        <tr>
        <tr>
          <td colspan="2" rowspan="4"><img src="<?= base_url("./img/logo_honda.jpg") ?>" width="70" height="50"></td>
        ...
        <tr>
          <td colspan="8" style="font-size:12px;">Honda Autoland Ciputat</td>
        <tr>
          <td colspan="8" style="font-size:12px;">Jl. ...</td>
        <tr>
          <td colspan="8" style="font-size:12px;">Jl. ...</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Tipe Faktur</td>
          <td style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tipe_faktur'] == "Personal" ? "checked" : "" ?> enabled></td>
          <td style="font-size:12px;">Personal</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tipe_faktur'] == "Company" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Company</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Tipe Pelanggan</td>
          <td style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tipe_pelanggan'] == "Personal" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Personal</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tipe_pelanggan'] == "Fleet" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Fleet</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Status Pelanggan</td>
          <td style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['status_pelanggan'] == "Baru" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Baru</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['status_pelanggan'] == "Lama" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Lama</td>
        <tr>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['sama_spk'] == "Y" ? "checked" : "" ?>></td>
        ...
        <tr>
          <td style="width:25px;height:20px;background:white;border:solid 1px black;text-align:center" colspan="15" style="font-size:12px;text-align:center"><b>DATA PEMESAN</b></td>
        ...
        <tr>
          ...
          <td colspan="1" style="font-size:12px;">Nomor KTP</td>
          <td width="5" style="font-size:12px;">:</td>
        ...
        <tr>
          <td style="width:25px;height:20px;background:white;border:solid 1px black;text-align:center" colspan="15" style="font-size:12px;text-align:center"><b>DATA FAKTUR</b></td>
        ...
        <tr>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['sama_pemesan'] == "Y" ? "checked" : "" ?>></td>
        ...
        <tr>
          <td style="width:25px;height:20px;background:white;border:solid 1px black;text-align:center" colspan="15" style="font-size:12px;text-align:center"><b>DATA KENDARAAN</b></td>
        ...
        <tr>
          ...
          <td width="5" style="font-size:12px;">:</td>
          <td colspan="5" style="font-size:12px;"> <?= $mohfaktur['tgl_dp'] ?></td>
        <tr>
          <td colspan="2" style="font-size:12px;">ETA</td>
          <td width="5" style="font-size:12px;">:</td>
          <td colspan="5" style="font-size:12px;"> <?= $mohfaktur['eta'] ?></td>
          <td></td>
          <td colspan="5" style="font-size:12px;">ETD : <?= $mohfaktur['etd'] ?></td>
        <tr>
          <td colspan="2" style="font-size:12px;">Paket</td>
          <td style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['paket'] == "Pahe 1" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Pahe 1</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['paket'] == "Pahe 2" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Pahe 2</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['paket'] == "Extended Warranty" ? "checked" : "" ?>></td>
        ...
        <tr>
          <td style="width:25px;height:20px;background:white;border:solid 1px black;text-align:center" colspan="15" style="font-size:12px;text-align:center"><b>INFORMASI TAMBAHAN</b></td>
        <tr>
          <td colspan="15">
            <br>
            <!-- <hr> -->
        ...
        <tr>
          ...
          <td style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['jekel'] == "Pria" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Pria</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['jekel'] == "Wanita" ? "checked" : "" ?>></td>
        ...
        <tr>
          ...
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['status_menikah'] == "Menikah" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Menikah</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['status_menikah'] == "Belum Menikah" ? "checked" : "" ?>></td>
          <td colspan="3" style="font-size:12px;">Belum Menikah</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Jumlah Keluarga Inti</td>
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['jumlah_keluarga'] == "1" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">1</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['jumlah_keluarga'] == "2" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">2</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['jumlah_keluarga'] == "3" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">3</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['jumlah_keluarga'] == "4" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">4</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['jumlah_keluarga'] == "5" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">>=5</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Agama</td>
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['agama'] == "ISLAM" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Islam</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['agama'] == "KRISTEN PROTESTAN" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Katolik</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['agama'] == "KRISTEN KATHOLIK" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Kristen</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['agama'] == "BUDHA" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Budha</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['agama'] == "HINDU" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Hindu</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['agama'] == "LAIN-LAIN (KEPERCAYAAN)" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Kong Hu Cu</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Pekerjaan</td>
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['pekerjaan'] == "Tentara" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Tentara</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['pekerjaan'] == "Dokter" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Dokter</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['pekerjaan'] == "Pegawai Pemerintah" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Pegawai Pemerintah</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['pekerjaan'] == "Pegawai Swasta" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Pegawai Swasta</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['pekerjaan'] == "Pengacara" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Pengacara</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['pekerjaan'] == "Arsitek" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Arsitek</td>
        <tr>
          <td colspan="3" style="font-size:12px;"></td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tipe_faktur'] == "Pelajar" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Pelajar</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tipe_faktur'] == "Guru/Dosen" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Guru/Dosen</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tipe_faktur'] == "Lain-Lain" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Lain-Lain</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Metode Pembelian</td>
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['metode_pembelian'] == "Mobil Pertama" ? "checked" : "" ?>></td>
          <td colspan="2" style="font-size:12px;">Mobil Pertama</td>
        <tr>
          <td colspan="3" style="font-size:12px;"></td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['metode_pembelian'] == "Mobil Tambahan" ? "checked" : "" ?>></td>
          <td colspan="2" style="font-size:12px;">Mobil Tambahan</td>
          <td></td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tambah_honda'] == "Y" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Honda</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['tambah_nonhonda'] == "Y" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Bukan Honda</td>
        <tr>
          <td colspan="3" style="font-size:12px;"></td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['metode_pembelian'] == "Mobil Pengganti" ? "checked" : "" ?>></td>
          <td colspan="2" style="font-size:12px;">Mobil Pengganti</td>
          <td></td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['ganti_honda'] == "Y" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Honda</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['ganti_nonhonda'] == "Y" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Bukan Honda</td>
        <tr>
          <td colspan="2" style="font-size:12px;">Metode Pembayaran</td>
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['metode_pembayaran'] == "Cash" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Cash</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['metode_pembayaran'] == "Credit" ? "checked" : "" ?>></td>
        ...
        <tr>
          ...
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['asuransi'] == "Y" ? "checked" : "" ?>></td>
          <td style="font-size:12px;">Ya</td>
          <td style="font-size:12px;"> <input disabled type="checkbox" <?= $mohfaktur['asuransi'] == "N" ? "checked" : "" ?>></td>
