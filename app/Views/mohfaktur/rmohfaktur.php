    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div class="input-group">
          ...
          <div class="col-md-1">
            <!-- <a href="" target="_blank" onclick="cetakrmohfaktur()">aaaa</a> -->
            <!-- <button class="btn btn-flat btn-success btn-sm mb-2 mt-2 btnrmohfaktur" onclick="cetakrmohfaktur()" type="button"><i class="fa fa-print"></i> Print</button> -->
          </div>
        </div>
        <div id="tabel_rmohfaktur"></div>
      </div>
    </div>
  </div>
</main>
...
<script>
  function cetakrmohfaktur() {
    ...
    var w = window.open('mohfaktur/cetakrmohfaktur/' + tanggal1);
    $.ajax({
      type: "post",
      data: {
      ...
      // url: "<?= site_url('mohfaktur/cetakrmohfaktur'); ?>",
  ...
  function reload_table() {
    ...
    $.ajax({
      ...
      url: "<?= site_url('mohfaktur/table_rmohfaktur'); ?>",
      // data: {
      // id: $id
      // },
      beforeSend: function(f) {
        ...
        // alert('1');
        $('#tabel_rmohfaktur').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_rmohfaktur').html(data);
