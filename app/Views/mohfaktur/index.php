...
<div class="viewmodalmohfaktur" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('mohfaktur/table_mohfaktur'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_mohfaktur').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_mohfaktur').html(data);
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('mohfaktur/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('mohfaktur/modaldetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailmohfaktur($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('wo/detailmohfaktur') ?>",
      dataType: "json",
      data: {
        id: $id
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modaldetail_mohfaktur').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function detail_mohfaktur($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('mohfaktur/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailmohfaktur($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailmohfaktur') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function modalmohfaktur($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('mohfaktur/modalmohfaktur') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
  ...
  function unproses_mohfaktur($id) {
    swal({
