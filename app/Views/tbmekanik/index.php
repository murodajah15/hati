...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbmekanik/table_mekanik'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_mekanik').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_mekanik').html(data);
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbmekanik/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailmobil($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('tbmekanik/detailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbmekanik/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbmekanik/";
          $.ajax({
            url: "<?php echo site_url('tbmekanik/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
