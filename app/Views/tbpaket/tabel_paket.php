...
<div class="row">
  ...
  <div class="container mt-1">
    <div class="col-12 col-sm-12">
      <!-- <table class="table table-bordered table-striped" id="tbl-paket-data"> -->
      <table id="tbl-paket-data" class="table table-striped" style="width:100%">
        <!-- <table class="table"> -->
        <thead>
          <tr>
  ...
  <script>
    $(document).ready(function() {
      $('#tbl-paket-data').DataTable({
        ...
        ajax: {
          url: '<?= site_url('/tbpaket/ajax-load-data') ?>',
          type: 'POST',
        },
        columns: [{
            data: null,
          ...
          },
          {
            data: null,
            render: function(data, type, row, meta) {
              return `<a href="#${row.id}"><button onclick="detail_paket(${row.id})" class='btn btn-sm btn-info' href='javascript:void(0)'><i class='fa fa-book'></i></button></a> 
