...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbnegara/table_negara'); ?>",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbnegara/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbnegara/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbnegara/";
          $.ajax({
            url: "<?php echo site_url('tbnegara/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
