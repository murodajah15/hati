...
<div class="viewmodalmemombr" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('memombr/table_memombr'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_memombr').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_memombr').html(data);
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('memombr/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('memombr/modaldetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/wo/";
          $.ajax({
            url: "<?php echo site_url('memombr/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function detail_memombr($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('memombr/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit_memombr($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('memombr/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailmemombr($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailmemombr') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailmemombr1($id) {
    $.get("wo/formdetailmemombr", {
      id: $id
    }, function(data) {
      $("#tabel_memombr").html(data);
    });
  ...
  function modalmemombr($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('memombr/modalmemombr') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
  ...
  function proses_memombr($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('memombr/proses') ?>/" + $id,
            data: {
              id: $id,
            },
            type: "POST",
  ...
  function unproses_memombr($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('memombr/unproses') ?>/" + $id,
            data: {
              id: $id,
            },
            type: "POST",
