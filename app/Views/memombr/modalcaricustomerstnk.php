<div class="modal fade" role="dialog" id="modalcaricustomerstnk" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
              ...
              <tbody id="isi_data" class="isi_data">
                ...
                foreach ($tbcustomer as $row) : ?>
                  <tr id="tr" style="cursor: pointer; ">
                    ...
                    <td id="td" hidden data-bs-dismiss="modal" onclick="post_data_tbcustomer();"><?= $row['npwp']; ?></td>
                  </tr>
                <?php $no++;
                endforeach; ?>
              </tbody>
  ...
  <script>
    ...
    function post_data_tbcustomer() {
      ...
      tbody.onclick = function(e) {
        ...
        $('#kdcustomer_stnk').val(((dt_split[1]).replace("--separator--", "")).trim());
        $('#nmcustomer_stnk').val(((dt_split[2]).replace("--separator--", "")).trim());
        $('#alamat_stnk').val(((dt_split[3]).replace("--separator--", "")).trim());
        $('#kelurahan_stnk').val(((dt_split[4]).replace("--separator--", "")).trim());
        $('#kecamatan_stnk').val(((dt_split[5]).replace("--separator--", "")).trim());
        $('#kota_stnk').val(((dt_split[6]).replace("--separator--", "")).trim());
        $('#provinsi_stnk').val(((dt_split[7]).replace("--separator--", "")).trim());
        $('#kodepos_stnk').val(((dt_split[8]).replace("--separator--", "")).trim());
        $('#nik_stnk').val(((dt_split[9]).replace("--separator--", "")).trim());
        $('#nik_kk').val(((dt_split[9]).replace("--separator--", "")).trim());
        $('#email_stnk').val(((dt_split[10]).replace("--separator--", "")).trim());
        $('#nohp_customer_stnk').val(((dt_split[11]).replace("--separator--", "")).trim());
        $('#npwp_stnk').val(((dt_split[12]).replace("--separator--", "")).trim());
      };
    }
  </script>