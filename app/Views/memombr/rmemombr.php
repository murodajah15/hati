    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div class="input-group">
          ...
          <div class="col-md-1">
            <!-- <a href="" target="_blank" onclick="cetakrmemombr()">aaaa</a> -->
            <!-- <button class="btn btn-flat btn-success btn-sm mb-2 mt-2 btnrmemombr" onclick="cetakrmemombr()" type="button"><i class="fa fa-print"></i> Print</button> -->
          </div>
        </div>
        <div id="tabel_rmemombr"></div>
      </div>
    </div>
  </div>
</main>
...
<script>
  function cetakrmemombr() {
    ...
    var w = window.open('memombr/cetakrmemombr/' + tanggal1);
    $.ajax({
      type: "post",
      data: {
      ...
      // url: "<?= site_url('memombr/cetakrmemombr'); ?>",
  ...
  function reload_table() {
    ...
    $.ajax({
      ...
      url: "<?= site_url('memombr/table_rmemombr'); ?>",
      // data: {
      // id: $id
      // },
      beforeSend: function(f) {
        ...
        // alert('1');
        $('#tabel_rmemombr').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_rmemombr').html(data);
