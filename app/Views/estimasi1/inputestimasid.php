  ...
  <div class="modal-dialog" style="max-width: 100%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        ?>
          <?= form_open('estimasi/simpanestimasid', ['class' => 'forminputestimasid']) ?>
          ...
          <div class="row mb-2 mt-4">
            <div class="col-12 col-sm-4">
              ...
              <div class="input-group mb-1">
                <input type='text' class='form-control form-control-sm mb-2' value="<?= $estimasi['noestimasi'] ?>" name="noestimasi" id="noestimasi" name="noestimasijadi" readonly style="width: 5%">
              ...
              <div class="row mb-2">
                <table class="table table-striped" style="width:100%">
                  ...
                  <tbody">
                    ...
                    <td><input type="text" name="qty" id="qty" class="form-control form-control-sm text-end" onkeyup="validAngka(this)" value=0 onblur="hit_ssubtotal()" required>
                      <div class="invalid-feedback errorQty">
                      </div>
                    </td>
                    <td><input type="text" name="harga" id="harga" class="form-control form-control-sm text-end" value=0 onblur="hit_ssubtotal()"></td>
...
<script>
  function hit_ssubtotal() {
    let text = document.getElementById("harga").value
    let harga = text.replace(",", "");
    let $total_sementara = parseInt(document.getElementById("qty").value) * harga;
        ...
        success: function(response) {
          if (response.error) {
            ...
            if (response.sukses == "Data gagal ditambah") {
              swal({
                icon: 'error',
                title: response.sukses, //"Data gagal ditambah ",
