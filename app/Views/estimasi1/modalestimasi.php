    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="nav nav-tabs">
          ...
          <li class="nav-item">
            <a href="#datawo" class="nav-link" data-bs-toggle="tab" id="tabestimasi">Estimasi & Work Order <button class="btn btn-flat btn-info btn-sm mb-2 btn-float-right btnreload" type="button"><i class="fa fa-spinner"></i></button></a>
          </li>
          <!-- <li class="nav-item">
