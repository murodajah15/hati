...
<div class="modal fade" id="edit_wo_bp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 90%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php if ($edit == 1) {
          if ($title == "Edit Data WO") {
          }
        ?>
          <?= form_open('estimasi_bp/update_wo_bp', ['class' => 'formedit_wo_bp']) ?>
          <?= csrf_field(); ?>
          <input type="hidden" id="id" name="id" value="<?= $wo_bp['id'] ?>">
          <div class="row mb-2 mt-4">
            <div class="col-12 col-sm-6">
              ...
              <div class="input-group mb-1">
                <input type='text' class='form-control form-control-sm mb-2' value="<?= $wo_bp['nowo'] ?>" id="nowo" name="nowo" readonly style="width: 5%">
              ...
              <div class="input-group mb-1">
                ...
                <input type="text" class="form-control form-control-sm mb-1" value="<?= $wo_bp['km'] ?>" placeholder="KM">
              </div>
              ...
              <!-- <div class="input-group mb-1">
              <input type="text" class="form-control form-control-sm mb-1" name="aktifitas" id="aktifitas" value="<?= $wo_bp['aktifitas'] ?>">
              <input type="text" class="form-control form-control-sm mb-1" name="fasilitas" id="fasilitas" value="<?= $wo_bp['fasilitas'] ?>">
            </div> -->
              Service Advisor
              <div class="input-group mb-2">
                <?php
                ...
                ?>
                <input type="text" style="width:5%;" name="kdsa" id="kdsa" class="form-control" placeholder="" value="<?= $wo_bp['kdsa'] ?>">
              ...
              <textarea class="form-control" name="keluhan" id="keluhan" rows="4"><?= $wo_bp['keluhan'] ?></textarea>
              <div class="invalid-feedback errorKeluhan">
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <label for="keluhan" class="form-label mb-1">Nama Polis</label>
              <input type="text" class="form-control form-control-sm" name="nama_polis" id="nama_polis" value="<?= $wo_bp['nama_polis'] ?>">
              <label for="keluhan" class="form-label mb-1">No. Polis</label>
              <input type="text" class="form-control form-control-sm" name="no_polis" id="no_polis" value="<?= $wo_bp['no_polis'] ?>">
              <label for="keluhan" class="form-label mb-1">Tgl. Berakhir</label>
              <input type="date" class="form-control form-control-sm" name="tgl_akhir_polis" id="tgl_akhir_polis" value="<?= $wo_bp['tgl_akhir_polis'] ?>">
              <label for="keluhan" class="form-label mb-1">Asuransi</label>
              <div class="input-group mb-1">
                <input type="text" class="form-control form-control-sm" name="kode_asuransi" id="kode_asuransi" value="<?= $wo_bp['kode_asuransi'] ?>">
                <input type="text" style="width: 40%" class="form-control form-control-sm" name="nama_asuransi" id="nama_asuransi" value="<?= $wo_bp['nama_asuransi'] ?>" readonly>
              ...
              <textarea class="form-control" name="alamat_asuransi" id="alamat_asuransi" rows="2" readonly><?= $wo_bp['alamat_asuransi'] ?></textarea>
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="klaim" name="klaim" <?= $wo_bp['klaim'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckDefault">Klaim</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="internal" name="internal" <?= $wo_bp['internal'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Internal</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="inventaris" name="inventaris" <?= $wo_bp['inventaris'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckDefault">Inventaris</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="campaign" name="campaign" <?= $wo_bp['campaign'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Campaign</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="booking" name="booking" <?= $wo_bp['booking'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Booking</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input mb-2" type="checkbox" value="" id="lain_lain" name="lain_lain" <?= $wo_bp['lain_lain'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Lain-lain</label>
              </div>
              <br>
              <label for="nama" class="form-label mb-1">PPN (%)</label>
              <input type="number" class="form-control form-control-sm mb-2" name="pr_ppn" id="pr_ppn" value="<?= $wo_bp['pr_ppn'] ?>">
              <label for="nama" class="form-label mb-1">NPWP</label>
              <input type="text" class="form-control form-control-sm mb-2" name="npwp" id="npwp" value="<?= $wo_bp['npwp'] ?>">
              <label for=" nama" class="form-label mb-1">Contact Person</label>
              <input type="text" class="form-control form-control-sm mb-2" name="contact_person" id="contact_person" value="<?= $wo_bp['contact_person'] ?>">
              <label for=" nama" class="form-label mb-1">Nomor Contact Person</label>
              <input type="text" class="form-control form-control-sm mb-2" name="no_contact_person" id="no_contact_person" value="<?= $wo_bp['no_contact_person'] ?>">
            </div>
          </div>
          <div class=" col-md-12">
            <button type="submit" value="wo" class="btn btn-flat btn-primary btn-sm btnupdate_wo_bp" id="btnupdate_wo_bp"><i class="fa fa-file"></i> Simpan</button>
...
<script>
  $(document).ready(function() {
    $('.formedit_wo_bp').on('click', '.btnupdate_wo_bp', function(e) {
      $('.formedit_wo_bp').submit(function(e) {
        e.preventDefault();
        $.ajax({
          url: $(this).attr('action'),
          // url: "<?= site_url('estimasi_bp/update_wo_bp') ?>",
          type: "post",
          data: $(this).serialize(),
          dataType: "json",
          beforeSend: function() {
            $('.btnupdate_wo_bp').attr('disable', 'disabled')
            $('.btnupdate_wo_bp').prop('disable', false)
            $('.btnupdate_wo_bp').html('<i class="fa fa-spin fa-spinner"></i>')
          },
          complete: function() {
            $('.btnupdate_wo_bp').removeAttr('disable')
            $('.btnupdate_wo_bp').html('<i class="fa fa-file"></i> update WO')
            $('.btnupdate_wo_bp').prop('disabled', true)
          },
