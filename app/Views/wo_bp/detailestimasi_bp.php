...
<div class="modal fade" id="detailestimasi" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 90%;">
    ...
    <div class="modal-footer">
      <button class="btn btn-flat btn-info btn-float-right btnreload" type="button" disabled><i class="fa fa-spinner"></i></button>
      <button type="button" class="btn btn-primary" onclick="simpankewo()">Simpan ke WO</button>
