...
<div class="modal fade" id="editestimasi_bp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 90%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        ?>
          <?= form_open('estimasi_bp/updateestimasi_bp', ['class' => 'formeditestimasi_bp']) ?>
          <?= csrf_field(); ?>
          <input type="hidden" id="id" name="id" value="<?= $estimasi_bp['id'] ?>">
          <div class="row mb-2 mt-4">
            <div class="col-12 col-sm-6">
              ...
              <div class="input-group mb-1">
                <input type='text' class='form-control form-control-sm mb-2' value="<?= $estimasi_bp['noestimasi'] ?>" id="noestimasi" name="noestimasi" readonly style="width: 5%">
              ...
              <div class="input-group mb-1">
                <select class="form-select form-select-sm" style="height: 31px;" name="kdservice" id="kdservice">
                  ...
                  for ($c = 0; $c < $jml_kata; $c += 1) {
                    if ($arr[$c] == $estimasi_bp['kdservice']) {
                ...
                <input type="text" class="form-control form-control-sm mb-1" value="<?= $estimasi_bp['km'] ?>" placeholder="KM">
              </div>
              ...
              //   if ($estimasi_bp['kdpaket'] == $key['kode']) {
              ...
              <div class="input-group mb-2">
                <select id='aktifitas' name='aktifitas' class="form-select form-select-sm" autofocus='autofocus'>
                  ...
                  $jml_kata = count($arr);
                  for ($c = 0; $c < $jml_kata; $c += 1) {
                    if ($arr[$c] == $estimasi_bp['aktifitas']) {
                      echo "<option value='$arr[$c]' selected>$arr[$c] </option>";
                    } else {
                      echo "<option value='$arr[$c]'> $arr[$c] </option>";
                    }
                ...
                <select id='fasilitas' name='fasilitas' class="form-select form-select-sm" style='width: 200x;' autofocus='autofocus'>
                  ...
                  $jml_kata = count($arr);
                  for ($c = 0; $c < $jml_kata; $c += 1) {
                    if ($arr[$c] == $estimasi_bp['fasilitas']) {
                      echo "<option value='$arr[$c]' selected>$arr[$c] </option>";
                    } else {
                      echo "<option value='$arr[$c]'> $arr[$c] </option>";
                    }
                ...
                <select id='status_tunggu' name='status_tunggu' class="form-select form-select-sm" style='width: 200x;' autofocus='autofocus'>
                  ...
                  $jml_kata = count($arr);
                  for ($c = 0; $c < $jml_kata; $c += 1) {
                    if ($arr[$c] == $estimasi_bp['status_tunggu']) {
                      echo "<option value='$arr[$c]' selected>$arr[$c] </option>";
                    } else {
                      echo "<option value='$arr[$c]'> $arr[$c] </option>";
                    }
              ...
              <div class="input-group mb-2">
                <select id='int_reminder' name='int_reminder' class="form-select form-select-sm" autofocus='autofocus'>
                  ...
                  $jml_kata = count($arr);
                  for ($c = 0; $c < $jml_kata; $c += 1) {
                    if ($arr[$c] == $estimasi_bp['int_reminder']) {
                      echo "<option value='$arr[$c]' selected>$arr[$c] </option>";
                    } else {
                      echo "<option value='$arr[$c]'> $arr[$c] </option>";
                    }
              ...
              <!-- <div class="input-group mb-1">
              <input type="text" class="form-control form-control-sm mb-1" name="aktifitas" id="aktifitas" value="<?= $estimasi_bp['aktifitas'] ?>">
              <input type="text" class="form-control form-control-sm mb-1" name="fasilitas" id="fasilitas" value="<?= $estimasi_bp['fasilitas'] ?>">
            </div> -->
              Service Advisor
              <div class="input-group mb-2">
                <?php
                ...
                ?>
                <input type="text" style="width:5%;" name="kdsa" id="kdsa" class="form-control" placeholder="" value="<?= $estimasi_bp['kdsa'] ?>">
              ...
              <textarea class="form-control" name="keluhan" id="keluhan" rows="4"><?= $estimasi_bp['keluhan'] ?></textarea>
              <div class="invalid-feedback errorKeluhan">
              </div>
            </div>
            <div class="col-12 col-sm-6">
              <label for="keluhan" class="form-label mb-1">Nama Polis</label>
              <input type="text" class="form-control form-control-sm" name="nama_polis" id="nama_polis" value="<?= $estimasi_bp['nama_polis'] ?>">
              <label for="keluhan" class="form-label mb-1">No. Polis</label>
              <input type="text" class="form-control form-control-sm" name="no_polis" id="no_polis" value="<?= $estimasi_bp['no_polis'] ?>">
              <label for="keluhan" class="form-label mb-1">Tgl. Berakhir</label>
              <input type="date" class="form-control form-control-sm" name="tgl_akhir_polis" id="tgl_akhir_polis" value="<?= $estimasi_bp['tgl_akhir_polis'] ?>">
              <label for="keluhan" class="form-label mb-1">Asuransi</label>
              <div class="input-group mb-1">
                <input type="text" class="form-control form-control-sm" name="kode_asuransi" id="kode_asuransi" value="<?= $estimasi_bp['kode_asuransi'] ?>">
                <input type="text" style="width: 40%" class="form-control form-control-sm" name="nama_asuransi" id="nama_asuransi" value="<?= $estimasi_bp['nama_asuransi'] ?>" readonly>
              ...
              <input type="text" class="form-control form-control-sm mb-2" name="surveyor" id="surveyor" value="">
              <label for="nama" class="form-label mb-0">Status WO</label>
              <br>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="klaim" name="klaim" <?= $estimasi_bp['klaim'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckDefault">Klaim</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="internal" name="internal" <?= $estimasi_bp['internal'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Internal</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="inventaris" name="inventaris" <?= $estimasi_bp['inventaris'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckDefault">Inventaris</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="campaign" name="campaign" <?= $estimasi_bp['campaign'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Campaign</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="booking" name="booking" <?= $estimasi_bp['booking'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Booking</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input mb-2" type="checkbox" value="" id="lain_lain" name="lain_lain" <?= $estimasi_bp['lain_lain'] > 0 ? "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckChecked">Lain-lain</label>
              </div>
              <br>
              <label for="nama" class="form-label mb-1">PPN (%)</label>
              <input type="number" class="form-control form-control-sm mb-2" name="pr_ppn" id="pr_ppn" value="<?= $estimasi_bp['pr_ppn'] ?>">
              <label for="nama" class="form-label mb-1">NPWP</label>
              <input type="text" class="form-control form-control-sm mb-2" name="npwp" id="npwp" value="<?= $estimasi_bp['npwp'] ?>">
              <label for=" nama" class="form-label mb-1">Contact Person</label>
              <input type="text" class="form-control form-control-sm mb-2" name="contact_person" id="contact_person" value="<?= $estimasi_bp['contact_person'] ?>">
              <label for=" nama" class="form-label mb-1">Nomor Contact Person</label>
              <input type="text" class="form-control form-control-sm mb-2" name="no_contact_person" id="no_contact_person" value="<?= $estimasi_bp['no_contact_person'] ?>">
            </div>
          </div>
          <div class=" col-md-12">
            <button type="submit" value="estimasi" class="btn btn-flat btn-primary btn-sm btnupdateestimasi_bp" id="btnupdateestimasi_bp"><i class="fa fa-file"></i> Simpan</button>
...
<script>
  $(document).ready(function() {
    $('.formeditestimasi_bp').on('click', '.btnupdateestimasi_bp', function(e) {
      $('.formeditestimasi_bp').submit(function(e) {
        e.preventDefault();
        $.ajax({
          url: $(this).attr('action'),
          // url: "<?= site_url('estimasi_bp/updateestimasi') ?>",
          type: "post",
          data: $(this).serialize(),
          dataType: "json",
          beforeSend: function() {
            $('.btnupdateestimasi_bp').attr('disable', 'disabled')
            $('.btnupdateestimasi_bp').prop('disable', false)
            $('.btnupdateestimasi_bp').html('<i class="fa fa-spin fa-spinner"></i>')
          },
          complete: function() {
            $('.btnupdateestimasi_bp').removeAttr('disable')
            $('.btnupdateestimasi_bp').html('<i class="fa fa-file"></i> update Estimasi')
            $('.btnupdateestimasi_bp').prop('disabled', true)
          },
  ...
  $('#carisa').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('estimasi_bp/caridatasa') ?>",
      dataType: "json",
      success: function(response) {
  ...
  $('#kdsa').on('blur', function(e) {
    ...
    if (cari !== "") {
      $.ajax({
        url: "<?= site_url('estimasi_bp/replsa') ?>",
        type: 'post',
        data: {
          'kdsa': cari
        },
  ...
  $('#cariasuransi').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('estimasi_bp/caridataasuransi') ?>",
      dataType: "json",
      success: function(response) {
  ...
  $('#kode_asuransi').on('blur', function(e) {
    ...
    if (cari !== "") {
      $.ajax({
        url: "<?= site_url('estimasi_bp/replasuransi') ?>",
        type: 'post',
        data: {
          'kode_asuransi': cari
        },
