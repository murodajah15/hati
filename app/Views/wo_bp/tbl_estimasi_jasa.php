...
<table class="table table-striped tbl_estimasi_jasa" style="width:100%">
  <thead>
    <tr>
      <th width="30">#</th>
      <th width="150">Kode JASA</th>
      <th width="300">Nama JASA</th>
      <th width="300">Kerusakan</th>
      <th width="70">Jam</th>
      <th width="100">FRT</th>
      <th width="90">Disc (%)</th>
      <th width="120">Disc (Rp.)</th>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        ?>
          <td><button class="btn btn-outline-warning btn-sm" onClick="editdetailestimasi_bp(`<?= $r['id'] ?>`)" type="button"><i class="fa fa-edit"></i></button>
            <button class="btn btn-outline-danger btn-sm" onClick="hapusdetailestimasi_bp(`<?= $r['id'] ?>`)" type="button" id="carijasa"><i class="fa fa-trash"></i></button>
          </td>
        <?php
        }
        ?>
...
<div class="col-12 col-sm-6">
  <table class="table table-striped" style="width:50%">
    ...
    <tbody>
      ...
      ?>
      <td><input type="text" class="form-control form-control-sm text-end" name="total_qty_jasa" id="total_qty_jasa" value="<?= $ftotal_qty ?>" readonly></td>
      <td><input type="text" class="form-control form-control-sm text-end" name="total_jasa" id="total_jasa" value="<?= $ftotal_discount ?>" readonly></td>
      <td><input type="text" class="form-control form-control-sm text-end" name="total_jasa" id="total_jasa" value="<?= $ftotal ?>" readonly></td>
    </tbody>
  </table>
</div>
