...
<div class="modal fade" role="dialog" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width:80%;">
    <div class="modal-content">
      ...
      <form action='saplikasi/simpandata' method='post' enctype='multipart/form-data' class='formsaplikasi'>
        <?= csrf_field(); ?>
        <div class="modal-body">
          ...
          <div class="row g-3 mb-2">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="pejabat_1" id="pejabat_1">
            </div>
            <div class="col-md-6">
              <label for="nama" class="form-label mb-1">Pejabat (2)</label>
              <input type="text" class="form-control" name="pejabat_2" id="pejabat_2">
            </div>
          </div>
          <div class="row g-3 mb-2">
            <div class="col-md-6">
