  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div id="tabel_pengeluarankasir"></div>
      </div>
    </div>
</main>
...
<div class="viewmodalpengeluarankasir" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('pengeluarankasir/table_pengeluarankasir'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_pengeluarankasir').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_pengeluarankasir').html(data);
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('pengeluarankasir/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('pengeluarankasir/modaldetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailpengeluarankasir($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('wo/detailpengeluarankasir') ?>",
      dataType: "json",
      data: {
        id: $id
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modaldetail_pengeluarankasir').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function hapus_pengeluarankasir($id) {
    swal({
  ...
  function detail_pengeluarankasir($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('pengeluarankasir/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit_pengeluarankasir($id) {
    $.ajax({
      type: "post",
  ...
  function formdetailpengeluarankasir($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailpengeluarankasir') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function modalpengeluarankasir($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('pengeluarankasir/modalpengeluarankasir') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modalpengeluarankasir').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function proses_pengeluarankasir($id) {
    swal({
  ...
  function unproses_pengeluarankasir($id) {
    swal({
  ...
  function cetak_pengeluarankasir($id) {
    // swal({
