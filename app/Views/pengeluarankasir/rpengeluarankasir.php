    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div class="input-group">
          ...
          <div class="col-md-1">
            <!-- <a href="" target="_blank" onclick="cetakrpengeluarankasir()">aaaa</a> -->
            <!-- <button class="btn btn-flat btn-success btn-sm mb-2 mt-2 btnrpengeluarankasir" onclick="cetakrpengeluarankasir()" type="button"><i class="fa fa-print"></i> Print</button> -->
          </div>
        </div>
        <div id="tabel_rpengeluarankasir"></div>
      </div>
    </div>
  </div>
</main>
...
<script>
  function cetakrpengeluarankasir() {
    ...
    var w = window.open('pengeluarankasir/cetakrpengeluarankasir/' + tanggal1);
    $.ajax({
      type: "post",
      data: {
      ...
      // url: "<?= site_url('pengeluarankasir/cetakrpengeluarankasir'); ?>",
  ...
  function reload_table() {
    ...
    $.ajax({
      ...
      url: "<?= site_url('pengeluarankasir/table_rpengeluarankasir'); ?>",
      // data: {
      // id: $id
      // },
      beforeSend: function(f) {
        ...
        // alert('1');
        $('#tabel_rpengeluarankasir').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_rpengeluarankasir').html(data);
