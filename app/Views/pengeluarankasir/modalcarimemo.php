            ...
            <table id="example" class="table table-bordered table-striped" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th colspan="37" style="text-align:center;" width="300">Pembeli</th>
                  <th hidden></th>
                </tr>
              </thead>
              <tbody id="isi_data" class="isi_data">
                ...
                foreach ($memombr as $row) : ?>
                  <tr id="tr" style="cursor: pointer; ">
                    ...
                    <td id="td" hidden data-bs-dismiss="modal" onclick="post_data_memombr();"><?= number_format($row['total'], 0, ".", ","); ?></td>
                  </tr>
                <?php $no++;
                endforeach; ?>
              </tbody>
  ...
  <script>
    ...
    function post_data_memombr() {
      ...
      tbody.onclick = function(e) {
        ...
        $('#piutang').val(((dt_split[40]).replace("--separator--", "")).trim());
