...
<div class="container-fluid">
  <div class="row">
    <p style="margin-top:5px;font-size:18px; margin-bottom:5px" align="center">
      <u>ESTIMASI BODY REPAIR</u>
    </p>
    <p style="margin-top:5px;font-size:14px; margin-bottom:5px" align="center"><?= $estimasi_bp['noestimasi'] ?></p>
    ...
    <table cellspacing="0" cellpadding="0" height="-2">
      ...
      <tr>
        ...
        <td width="150" style="font-size:10px" ;>: <?= $estimasi_bp['nmpemilik'] ?></td>
        <td width="60" style="font-size:11px;">MASUK</td>
        <td width="130" style="font-size:10px" ;>: <?= $estimasi_bp['tanggal'] ?></td>
    </table>
    <hr size="2.1">
