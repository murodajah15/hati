...
<table class="table table-striped tbl_wo_jasa" style="width:100%">
  <thead>
    <tr>
      <th width="30">#</th>
      <th width="150">Kode JASA</th>
      <th width="200">Nama JASA</th>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        ?>
          <td><button class="btn btn-outline-warning btn-sm" onClick="editdetailwo_bp(`<?= $r['id'] ?>`)" type="button"><i class="fa fa-edit"></i></button>
...
<script>
  $(document).ready(function() {
    $('.tbl_wo_jasa').DataTable();
  });

  function tampildetailpartwo_bp($id) {
    $.ajax({
      url: "<?php echo site_url('estimasi_bp/tampildetailpart') ?>/" + $id,
      type: "POST",
      data: {
        id: $id
      },
