...
<div class="viewmodalestimasi" style="display: none;"></div>
<div class="viewmodaldetailestimasi" style="display: none;"></div>
<div class="viewmodalwo" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('estimasi_bp/table_mobil'); ?>",
  ...
  function formdetailmobil($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function modalestimasi_bp($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('estimasi_bp/modalestimasi_bp') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodalestimasi').html(response.sukses).show();
