<div class="modal fade" role="dialog" id="modalbatal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?= form_open('estimasi_bp/simpan_batal_estimasi', ['class' => 'formbatal_estimasi']) ?>
        <?= csrf_field(); ?>

        <div class="row">
          <div class="col-lg-12 margin-tb">
            <input type="hidden" name="id" id="id" value="<?= $wo_bp['id'] ?>">
            <label for="kode" class="form-label mb-0">No. Estimasi</label>
            <input type="text" class="form-control mb-1" name="noestimasi" id="noestimasi" value="<?= $wo_bp['noestimasi'] ?>" readonly>
  ...
  <script>
    $(document).ready(function() {
      $('.formbatal_estimasi').on('click', '.btn-simpan', function(e) {
        $('.formbatal_estimasi').submit(function(e) {
          e.preventDefault();
          $.ajax({
