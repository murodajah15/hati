      ...
      <div class="modal-body">
        ...
        ?>
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a href="#opl" class="nav-link" data-bs-toggle="tab" id="tabopl">Pekerjaa n Luar</a>
            </li>
          </ul>
              ...
              <div class="row mb-2">
                <table class="table table-striped" style="width:100%">
                  ...
                  <tbody">
                    ...
                    <td><input type="text" name="pr_discountpart" id="pr_discountpart" class="form-control form-control-sm text-end" value=0 onblur="hit_ssubtotal_part()"></td>
