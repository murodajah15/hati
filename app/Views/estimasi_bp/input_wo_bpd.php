              ...
              <div class="row mb-2">
                <table class="table table-striped" style="width:100%">
                  ...
                  <tbody">
                    ...
                    <td hidden><input type="text" name="kdmekanik" id="kdmekanik" class="form-control form-control-sm text-end" value='' readonly></td>
                    <td hidden><input type="text" name="nmmekanik" id="subtotalopl" class="form-control form-control-sm text-end" value='' readonly></td>
...
<script>
  ...
  function tampildetailpartwo_bp($id) {
    $.ajax({
      url: "<?php echo site_url('estimasi_bp/tampildetailpartwo_bp') ?>/" + $id,
      type: "POST",
      data: {
        id: $id
      },
