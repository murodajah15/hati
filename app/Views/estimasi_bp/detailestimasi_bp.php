...
<div class="modal fade" id="detailestimasi" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 90%;">
        ...
        ?>
          ...
          <div class="row mb-2 mt-4">
            <div class="col-12 col-sm-6">
              ...
              ?>
              <label for="nama" class="form-label mb-1">No. Estimasi / Tanggal (M-D-Y) / No. WO</label>
              <div class="input-group mb-1">
                <input type='text' class='form-control form-control-sm mb-2' value="<?= $estimasi_bp['noestimasi'] ?>" id="noestimasijadi" name="noestimasijadi" readonly style="width: 5%">
                <input type="datetime-local" class='form-control form-control-sm mb-2' name='tanggal' id='tanggal' value="<?= $estimasi_bp['tanggal'] ?>" style="width: 30%" readonly>
                <input type='text' class='form-control form-control-sm mb-2' value="<?= $estimasi_bp['nowo'] ?>" id="nowojadi" name="nowojadi" readonly style="width: 5%">
              </div>
              ...
              <div class="input-group mb-1">
                ...
                <input type="text" class="form-control form-control-sm mb-1" value="<?= $estimasi_bp['km'] ?>" placeholder="KM" readonly>
              </div>
              <label for="nama" class="form-label mb-1">Paket</label>
              <input type="text" class="form-control form-control-sm mb-1" value="<?= $estimasi_bp['kdpaket'] ?>" placeholder="Paket" readonly>
              ...
              <div class="input-group mb-2">
                ...
                ?>
                <input type="text" style="width:5%;" name="kdsa" id="kdsa" class="form-control" placeholder="" value="<?= $estimasi_bp['kdsa'] ?>" readonly>
              ...
              <textarea class="form-control" name="keluhan" id="keluhan" rows="4" readonly><?= $estimasi_bp['keluhan'] ?></textarea>
            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="klaim" name="klaim" <?= $estimasi_bp['klaim'] > 0 ? "checked" : "" ?> disabled>
                <label class="form-check-label" for="flexCheckDefault">Klaim</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="internal" name="internal" <?= $estimasi_bp['internal'] > 0 ? "checked" : "" ?> disabled>
                <label class="form-check-label" for="flexCheckChecked">Internal</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="inventaris" name="inventaris" <?= $estimasi_bp['inventaris'] > 0 ? "checked" : "" ?> disabled>
                <label class="form-check-label" for="flexCheckDefault">Inventaris</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="campaign" name="campaign" <?= $estimasi_bp['campaign'] > 0 ? "checked" : "" ?> disabled>
                <label class="form-check-label" for="flexCheckChecked">Campaign</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" value="" id="booking" name="booking" <?= $estimasi_bp['booking'] > 0 ? "checked" : "" ?> disabled>
                <label class="form-check-label" for="flexCheckChecked">Booking</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input mb-2" type="checkbox" value="" id="lain_lain" name="lain_lain" <?= $estimasi_bp['lain_lain'] > 0 ? "checked" : "" ?> disabled>
                <label class="form-check-label" for="flexCheckChecked">Lain-lain</label>
              </div>
              <br>
              <label for="nama" class="form-label mb-1">PPN (%)</label>
              <input type="number" class="form-control form-control-sm mb-2" name="pr_ppn" id="pr_ppn" value="<?= $estimasi_bp['pr_ppn'] ?>" readonly>
    ...
    <div class="modal-footer">
      <?php
      if ($estimasi_bp["nowo"] == "" and $estimasi_bp["close"] == 1) {
      ?>
        <button type="button" class="btn btn-primary btnsimpankewo" id="btnsimpankewo" onclick="simpankewo()">Simpan ke WO</button>
      <?php
      }
      ?>
...
<script>
  function simpankewo() {
    ...
    $.ajax({
      ...
      dataType: "json",
      beforeSend: function() {
        $('.btnsimpankewo').attr('disable', 'disabled')
        $('.btnsimpankewo').html('<i class="fa fa-spin fa-spinner"></i>')
      },
      complete: function() {
        $('.btnsimpankewo').removeAttr('disable')
        $('.btnsimpankewo').html('<i class="fa fa-spiner"></i>')
        $('.btnsimpankewo').html('<i class="fa fa-file"></i> Simpan')
      },
