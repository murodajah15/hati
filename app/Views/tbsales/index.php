...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbsales/table_sales'); ?>",
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('tbsales/formtambah') ?>",
      dataType: "json",
      success: function(response) {
        $('.viewmodal').html(response.data).show();
        $('#modaltambahtbsales').modal('show');
      },
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbsales/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbsales/";
          $.ajax({
            url: "<?php echo site_url('tbsales/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
