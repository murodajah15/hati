...
<div class="modal fade" id="modaledit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 50%;">
    <div class="modal-content">
      ...
      <input type="hidden" class="form-control" name="kodelama" id="kodelama" value="<?= $tbdisc['kode'] ?>">
      <div class="modal-body">
        <div class="col-md-6 mb-2">
          <label for="kode" class="form-label mb-1">Kode</label>
          <input type="text" class="form-control" name="kode" id="kode" value="<?= $tbdisc['kode'] ?>">
          <div class="invalid-feedback errorKode">
          </div>
        </div>
        <label for="nama" class="form-label mb-1">Disc Normal</label>
        <input type="number" step="0.01" class="form-control mb-2" name="disc_normal" id="disc_normal" value="<?= $tbdisc['disc_normal'] ?>">
        <label for="nama" class="form-label mb-1">Disc Urgent</label>
        <input type="number" step="0.01" class="form-control mb-2" name="disc_urgent" id="disc_urgent" value="<?= $tbdisc['disc_urgent'] ?>">
        <label for="nama" class="form-label mb-1">Disc Hotline</label>
        <input type="number" step="0.01" class="form-control mb-2" name="disc_hotline" id="disc_hotline" value="<?= $tbdisc['disc_hotline'] ?>">
