...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbklpjasa/table_klpjasa'); ?>",
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('tbklpjasa/formtambah') ?>",
      dataType: "json",
      success: function(response) {
        $('.viewmodal').html(response.data).show();
        $('#modaltambahtbklpjasa').modal('show');
      },
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbklpjasa/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbklpjasa/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbklpjasa/";
          $.ajax({
            url: "<?php echo site_url('tbklpjasa/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
