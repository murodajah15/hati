...
<div class="row">
  <div class="container-fluid mt-2">
    ...
    <div class="container mt-2">
      ...
      <!-- <table class="table table-bordered table-striped" id="tbl-leasing-data"> -->
      <table id="tbl-leasing-data" class="table table-striped" style="width:100%">
        <!-- <table class="table"> -->
        <thead>
          <tr>
            <th width="30">#</th>
...
<script>
  $(document).ready(function() {
    $('#tbl-leasing-data').DataTable({
      ...
      ajax: {
        url: '<?= site_url('/tbleasing/ajax-load-data') ?>',
        type: 'POST',
      },
      columns: [{
          data: null,
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('tbleasing/formtambah') ?>",
      dataType: "json",
      success: function(response) {
        $('.viewmodal').html(response.data).show();
        $('#modaltambahleasing').modal('show');
      },
