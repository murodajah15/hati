...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbsatuan/table_satuan'); ?>",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbsatuan/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbsatuan/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbsatuan/";
          $.ajax({
            url: "<?php echo site_url('tbsatuan/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
