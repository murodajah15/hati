...
<div class="modaldetail" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tasklist_bp/table_tasklist_bp'); ?>",
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('tasklist_bp/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tasklist_bp/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tasklist_bp/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tasklist_bp/";
          $.ajax({
            url: "<?php echo site_url('tasklist_bp/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function detail_tasklist_bp($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tasklist_bp/formdetailtasklist_bp') ?>",
      dataType: "json",
      data: {
        id: $id
      },
