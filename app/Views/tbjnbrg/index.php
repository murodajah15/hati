...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbjnbrg/table_jnbrg'); ?>",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbjnbrg/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbjnbrg/";
          $.ajax({
            url: "<?php echo site_url('tbjnbrg/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
