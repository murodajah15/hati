...
<div class="modal fade" role="dialog" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 80%;">
    <div class="modal-content">
      ...
      <?= form_open('tbmobil/simpandata', ['class' => 'formtbmobil']) ?>
      <?= csrf_field(); ?>
      <div class="modal-body">
        <div class="row mb-2">
          <div class="col-12 col-sm-6">
            <label for="kode" class="form-label mb-0">No. Polisi</label>
            <input type="text" class="form-control mb-1" name="nopolisi" id="nopolisi" required>
            <div class="invalid-feedback errorNopolisi">
            </div>
            <label for="nama" class="form-label mb-0">No. Rangka</label>
            <input type="text" class="form-control mb-1" name="norangka" id="norangka" required>
            <label for="nama" class="form-label mb-0">No. Mesin</label>
            <input type="text" class="form-control mb-1" name="nomesin" id="nomesin" required>
            <label for="nama" class="form-label mb-0">Merek</label>
            <select class="form-select mb-1" name="kdmerek" id="kdmerek" required>
          ...
          <div class="col-12 col-sm-6">
            <div class="input-group">
              <div class="col-md-8">
                ...
                <input type="text" class="form-control mb-1" name="nostnk" id="nostnk">
              </div>
              <div class="col-md-4">
                <label for="nama" class="form-label mb-0">Tgl. STNK</label>
                <input type="date" class="form-control mb-1" name="tglstnk" id="tglstnk">
              </div>
            </div>
            <label for="nama" class="form-label mb-0">Bahan Bakar</label>
            <input type="text" class="form-control mb-1" name="bahanbakar" id="bahanbakar">
            <label for="nama" class="form-label mb-0">Dealer Penjualan</label>
            <input type="text" class="form-control mb-1" name="dealerjual" id="dealerjual">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Pemilik" name="kdpemilik" id="kdpemilik" class="col-4">
              <button class="btn btn-outline-secondary btn-sm" type="button" id="caripemilik">Cari</button>
              <input type="text" class="col-8" class="form-control" name="nmpemilik" id="nmpemilik" readonly>
              <input type="hidden" class="form-control" name="npwp" id="npwp" readonly>
              <input type="hidden" class="form-control" name="contact_person" id="contact_person" readonly>
              <input type="hidden" class="form-control" name="no_contact_person" id="no_contact_person" readonly>
            </div>
            <label for="nama" class="form-label mb-0">Pemakai</label>
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Pemakai" name="kdpemakai" id="kdpemakai" class="col-4">
              <button class="btn btn-outline-secondary btn-sm" type="button" id="caripemakai">Cari</button>
              <input type="text" class="col-8" class="form-control" name="nmpemakai" id="nmpemakai" readonly>
            </div>
            NPWP <input type="text" class="form-control" name="npwp" id="npwp">
            Contact Person <input type="text" class="form-control" name="contact_person" id="contact_person">
            No. Contact Person <input type="text" class="form-control" name="no_contact_person" id="no_contact_person">
            <label for="keluhan" class="form-label mb-1">Asuransi</label>
            <div class="input-group mb-1">
              <input type="text" class="form-control form-control-sm" name="kode_asuransi" id="kode_asuransi">
              <input type="text" style="width: 40%" class="form-control form-control-sm" name="nama_asuransi" id="nama_asuransi">
