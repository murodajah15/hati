              ...
              <tbody id="isi_data" class="isi_data">
                ...
                foreach ($tbcustomer as $row) : ?>
                  <tr id="tr" style="cursor: pointer; ">
                    <td><?= $no; ?></td>
                    <td id="td" data-bs-dismiss="modal" onclick="post_data_pemilik();"><?= $row['kode']; ?></td>
                    <td data-bs-dismiss="modal" onclick="post_data_pemilik();"><?= $row['nama']; ?></td>
                    <td data-bs-dismiss="modal" onclick="post_data_pemilik();"><?= $row['alamat']; ?></td>
                    <td hidden data-bs-dismiss="modal" onclick="post_data_pemilik();"><?= $row['npwp']; ?></td>
                    <td hidden data-bs-dismiss="modal" onclick="post_data_pemilik();"><?= $row['contact_person']; ?></td>
                    <td hidden data-bs-dismiss="modal" onclick="post_data_pemilik();"><?= $row['no_contact_person']; ?></td>
                  </tr>
                <?php $no++;
                endforeach; ?>
              </tbody>
