...
<script>
  ...
  function reload_table() {
    ...
    ?>
    $(document).ready(function() {
      $('#tbl-asuransi-data').DataTable();
    });

    $.ajax({
      url: "<?= site_url('tbasuransi/table_asuransi'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_asuransi').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_asuransi').html(data);
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbasuransi/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailmobil($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('tbasuransi/detailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbasuransi/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbasuransi/";
          $.ajax({
            url: "<?php echo site_url('tbasuransi/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function formdetailmobil($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbasuransi/formdetailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailmobil1($id) {
    $.get("tbasuransi/formdetailmobil", {
      id: $id
    }, function(data) {
      $("#tabel_asuransi").html(data);
    });
  ...
  function carinopolisi() {
    $.ajax({
      url: "<?= site_url('tbasuransi/cari_nopolisi') ?>",
      dataType: "json",
      success: function(response) {
