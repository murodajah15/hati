...
<div class="modal fade" role="dialog" id="modaltambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width:80%;">
    <div class="modal-content">
      ...
      <!-- <?= form_open_multipart('tbuser/simpandata', ['class' => 'formtbuser']) ?> -->
      <form action='tbuser/simpandata' method='post' enctype='multipart/form-data' class='formtbuser'>
        <?= csrf_field(); ?>
        <div class="modal-body">
          ...
          <div class="row g-3 mb-2">
            ...
            <div class="col">
              <label for="nama" class="form-label mb-0 labeltipe">Kelompok</label>
              <select class="form-select mb-1" name="kelompok" id="kelompok" role>
            ...
            <div class="row g-3 mb-1">
              ...
              <div class="col">
                ...
                <div class="col-sm-8">
                  <div class="mb-3">
                    <input type="file" accept="image/png, image/jpeg" class="form-control" id="photo" name="photo" onchange="previewImg()">
