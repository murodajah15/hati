...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbmodel/table_model'); ?>",
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('tbmodel/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbmodel/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbmodel/";
          $.ajax({
            url: "<?php echo site_url('tbmodel/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
