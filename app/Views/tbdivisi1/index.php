  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        ?>
        <!-- <a href="/tbdivisi/create"><i class="fa fa-plus"></i> Tambah Data Divisi</a> -->
        ...
        <table class="table table-bordered table-stripted" id="tbl-divisi">
          <!-- <table class="table"> -->
          <thead>
            <tr>
              <th scope="col">#</th>
            ...
            <?php foreach ($tbdivisi as $k) : ?>
              <tr>
                ...
                <td>
                  ...
                  <?php if ($edit == 1) {
                  ?>
                    <a href="/tbdivisi/edit/<?= $k['id']; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                  <?php
                  } else { ?>
