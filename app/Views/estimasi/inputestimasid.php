  ...
  <div class="modal-dialog" style="max-width: 100%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        ?>
          <?= form_open('estimasi/simpanestimasidxxx', ['class' => 'forminputestimasid']) ?>
          ...
          <div class="row mb-2 mt-4">
            <div class="col-12 col-sm-4">
              ...
              <div class="input-group mb-1">
                <input type='text' class='form-control form-control-sm mb-2' value="<?= $estimasi['noestimasi'] ?>" name="noestimasi" id="noestimasi" readonly style="width: 5%">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="jasa">
              <?= form_open('estimasi/simpanestimasidxxx', ['class' => 'forminputjasa']) ?>
            ...
            <div class="tab-pane fade " id="bahan">
              <?= form_open('estimasi/simpanestimasidxxx', ['class' => 'forminputbahan']) ?>
              <input type='hidden' class='form-control form-control-sm mb-2' value="<?= $estimasi['noestimasi'] ?>" name="noestimasi" id="noestimasi" readonly style="width: 5%">
              <?= csrf_field(); ?>
              <div class="row mb-2">
                <table class="table table-striped" style="width:100%">
            ...
            <div class="tab-pane fade " id="opl">
              <?= form_open('estimasi/simpanestimasidxxx', ['class' => 'forminputopl']) ?>
              <input type='hidden' class='form-control form-control-sm mb-2' value="<?= $estimasi['noestimasi'] ?>" name="noestimasi" id="noestimasi" readonly style="width: 5%">
              <?= csrf_field(); ?>
              <div class="row mb-2">
                <table class="table table-striped" style="width:100%">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#kodepart').on('blur', function(e) {
      ...
      if (cari !== "") {
        $.ajax({
          url: "<?= site_url('estimasi/replpart') ?>",
          type: 'post',
          data: {
            'kodepart': cari
          },
    ...
    $('#kodejasa').on('blur', function(e) {
      ...
      if (cari !== "") {
        $.ajax({
          url: "<?= site_url('estimasi/repljasa') ?>",
          type: 'post',
          data: {
            'kodejasa': cari
          },
    ...
    $('#kodebahan').on('blur', function(e) {
      ...
      if (cari !== "") {
        $.ajax({
          url: "<?= site_url('estimasi/replbahan') ?>",
          type: 'post',
          data: {
            'kodebahan': cari
          },
  ...
  $(document).ready(function() {
    ...
    $('.forminputbahan').submit(function() {
      $.ajax({
        type: "post",
        url: "<?= site_url('estimasi/simpanbahan') ?>",
        data: $(this).serialize(),
        dataType: "json",
        beforeSend: function() {
    ...
    $('.forminputopl').submit(function() {
      $.ajax({
        type: "post",
        url: "<?= site_url('estimasi/simpanopl') ?>",
        data: $(this).serialize(),
        dataType: "json",
        beforeSend: function() {
    ...
    $('.forminputjasa').submit(function() {
      $.ajax({
        type: "post",
        url: "<?= site_url('estimasi/simpanjasa') ?>",
        data: $(this).serialize(),
        dataType: "json",
        beforeSend: function() {
    ...
    $('#caripart').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('estimasi/caridatapart') ?>",
        dataType: "json",
        success: function(response) {
    ...
    $('#caribahan').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('estimasi/caridatabahan') ?>",
        dataType: "json",
        success: function(response) {
          $('.viewmodalcari').html(response.data).show();
          $('#modalcari').modal('show');
    ...
    $('#cariopl').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('estimasi/caridataopl') ?>",
        dataType: "json",
        success: function(response) {
          $('.viewmodalcari').html(response.data).show();
          $('#modalcari').modal('show');
    ...
    $('#carijasa').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('estimasi/caridatajasa') ?>",
        dataType: "json",
        success: function(response) {
          $('.viewmodalcari').html(response.data).show();
          $('#modalcari').modal('show');
    ...
    $('.forminputestimasid').submit(function() {
      $.ajax({
        type: "post",
        // url: $(this).attr('action'),
        url: "<?= site_url('estimasi/simpanestimasid') ?>",
        data: $(this).serialize(),
        dataType: "json",
        beforeSend: function() {
  ...
  function hapusdetailestimasi($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('estimasi/hapusdetailestimasi') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
  ...
  function reload_table_estimasi() {
    ...
    $.ajax({
      ...
      beforeSend: function(f) {
        ...
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_estimasi').html('<center>Loading Table1 ...</center>');
      },
      success: function(data) {
        // alert(data);
  ...
  $("#detailestimasi").on('hide.bs.modal', function() {
