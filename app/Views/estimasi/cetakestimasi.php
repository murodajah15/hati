...
<?php
if ($estimasi['close'] == 'N') {
  echo '<script>alert("Estimasi belum di close !")</script>';
...
<div class="container-fluid">
  <div class="row">
    <p style="margin-top:5px;font-size:18px; margin-bottom:5px" align="center">
      <u>ESTIMASI WORK ORDER</u>
    </p>
    <p style="margin-top:5px;font-size:14px; margin-bottom:5px" align="center"><?= $estimasi['noestimasi'] ?></p>
    ...
    <table cellspacing="0" cellpadding="0" height="-2">
      ...
      <tr>
        ...
        <td width="150" style="font-size:10px" ;>: <?= $estimasi['nmpemilik'] ?></td>
        <td width="60" style="font-size:11px;">MASUK</td>
        <td width="130" style="font-size:10px" ;>: <?= $estimasi['tanggal'] ?></td>
    </table>
    <hr size="2.1">
    <table class="table table-bordered table-striped" cellpadding="1" cellspacing="0">
      ...
      <thead>
        <tr>
          <th style="font-size:11px;" width="9">NO.</th>
          <th style="font-size:11px;" width="70"></th>
          <th style="font-size:11px;" width="200">PEKERJAAN UTAMA</th>
          <th style="font-size:11px;text-align:right;" width="80">HARGA</th>
          <th style="font-size:11px;text-align:right;" width="80">DISCOUNT</th>
          <th style="font-size:11px;text-align:right;" width="80">TOTAL</th>
        </tr>
      </thead>
      <?php
      $n = 0;
    ...
    <table class="table table-bordered table-striped" cellpadding="1" cellspacing="0">
      ...
      <thead>
        <tr>
          <th style="font-size:11px;" width="9">NO.</th>
          <th style="font-size:11px;text-align:left;" width="70">NO. PART</th>
          <th style="font-size:11px;text-align:left;" width="179">NAMA PART</th>
          <th style="font-size:11px;text-align:left;" width="20">QTY</th>
          <th style="font-size:11px;text-align:right;" width="80">HARGA</th>
          <th style="font-size:11px;text-align:right;" width="80">DISCOUNT</th>
          <th style="font-size:11px;text-align:right;" width="80">TOTAL</th>
        </tr>
    ...
    <table class="table table-bordered table-striped" cellpadding="1" cellspacing="0">
      ...
      <thead>
        <tr>
          <th style="font-size:11px;" width="9">NO.</th>
          <th style="font-size:11px;text-align:left;" width="70">NO. BAHAN</th>
          <th style="font-size:11px;text-align:left;" width="179">NAMA BAHAN</th>
          <th style="font-size:11px;text-align:left;" width="20">QTY</th>
          <th style="font-size:11px;text-align:right;" width="80">HARGA</th>
          <th style="font-size:11px;text-align:right;" width="80">DISCOUNT</th>
          <th style="font-size:11px;text-align:right;" width="80">TOTAL</th>
    ...
    <table class="table table-bordered table-striped" cellpadding="1" cellspacing="0">
      ...
      <thead>
        <tr>
          <th style="font-size:11px;" width="9">NO.</th>
          <th style="font-size:11px;text-align:left;" width="70">NO. OPL</th>
          <th style="font-size:11px;text-align:left;" width="200">NAMA OPL</th>
          <th style="font-size:11px;text-align:right;" width="80">HARGA</th>
          <th style="font-size:11px;text-align:right;" width="80">DISCOUNT</th>
          <th style="font-size:11px;text-align:right;" width="80">TOTAL</th>
        </tr>
