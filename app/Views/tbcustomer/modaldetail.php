          ...
          <div class="tab-pane fade show active" id="home">
            ...
            <div class="row mb-2">
              <div class="col-12 col-sm-6">
                ...
                <input type='text' class='form-control mb-2' name='provinsi' id='provinsi' value="<?= $tbcustomer['provinsi'] ?>" readonly>
                ...
                <input type='email' class='form-control' name='email' id='email' value="<?= $tbcustomer['email'] ?>" readonly>
              ...
              <div class="col-12 col-sm-6">
                ...
                <label for="nama" class="form-label mb-1">Provinsi</label>
                <input type='text' class='form-control mb-2' name='provinsi' id='provinsi' value="<?= $tbcustomer['provinsi_ktp'] ?>" readonly>
            ...
            <div class="row g-3 mb-2">
              <div class="col">
                <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
                  ...
                  <tr>
                    ...
                    <td> <input type='text' class='form-control' name='kota_ktr' id='kota_ktr' value="<?= $tbcustomer['provinsi_ktr'] ?>" readonly></td>
                  </tr>
                  <tr>
              ...
              <div class="col">
                <table style=font-size:13px; class='table table-striped table table-bordered' width='600px'>
                  ...
                  <tr>
                    <td>No. Telp CP</td>
                    <td> <input type='text' class='form-control' name='no_contact_person' value="<?= $tbcustomer['no_contact_person'] ?>"></td>
                  </tr>
                  <tr>
                    <td>NPWP</td>
