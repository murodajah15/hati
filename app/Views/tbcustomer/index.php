...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbcustomer/table_customer'); ?>",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbcustomer/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailmobil($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('tbcustomer/detailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbcustomer/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbcustomer/";
          $.ajax({
            url: "<?php echo site_url('tbcustomer/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function formdetailmobil($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbcustomer/formdetailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailmobil1($id) {
    $.get("tbcustomer/formdetailmobil", {
      id: $id
    }, function(data) {
      $("#tabel_customer").html(data);
    });
