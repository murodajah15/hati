...
<table class="table table-striped tbl_wo_bahan" style="width:100%">
  <thead>
    <tr>
      <th width="30">#</th>
  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        ?>
          <td><button class="btn btn-outline-warning btn-sm" onClick="tampildetailbahanwo(`<?= $r['id'] ?>`)" type="button"><i class="fa fa-edit"></i></button>
...
<script>
  $(document).ready(function() {
    $('.tbl_wo_bahan').DataTable();
  });

  function tampildetailbahanwo($id) {
    $.ajax({
      url: "<?php echo site_url('estimasi_bp/tampildetailbahanwo') ?>/" + $id,
      type: "POST",
      data: {
        id: $id
      },
      ...
      success: function(data) {
        ...
        document.getElementById("kodebahan").value = data_response['kodebahan'];
        document.getElementById("namabahan").value = data_response['namabahan'];
        document.getElementById("qtybahan").value = data_response['qtybahan'];
        document.getElementById("hargabahan").value = data_response['hargabahan'];
        document.getElementById("pr_discountbahan").value = data_response['pr_discountbahan'];
        ...
        document.getElementById("subtotalbahan").value = data_response['subtotalbahan'];
      },
