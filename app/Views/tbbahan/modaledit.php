...
<div class="modal fade" id="modaledit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" style="max-width: 80%;">
    <div class="modal-content">
      ...
      <?= form_open('tbbahan/updatedata', ['class' => 'formtbbahan']) ?>
      <input type="hidden" class="form-control" name="id" id="id" value="<?= $tbbahan['id'] ?>">
      <input type="hidden" class="form-control" name="kodelama" id="kodelama" value="<?= $tbbahan['kode'] ?>">
      <div class="modal-body">
        <div class="row">
          <div class="col-12 col-sm-6">
            <label for="kode" class="form-label mb-1">Kode</label>
            <input type="text" class="form-control" name="kode" id="kode" value="<?= $tbbahan['kode'] ?>">
            <div class="invalid-feedback errorKode">
            </div>
            <label for="nama" class="form-label mb-1">Nama</label>
            <input type="text" class="form-control mb-2" name="nama" id="nama" value="<?= $tbbahan['nama'] ?>">
            <div class="invalid-feedback errorNama">
            </div>
            <div class="input-group mb-2">
              <input type="text" name="kdnegara" id="kdnegara" class="form-control" placeholder="Buatan Negara" aria-label="Buatan Negara" value="<?= $tbbahan['kdnegara'] ?>">
            ...
            <input type="text" class="form-control" name="lokasi" id="lokasi" value="<?= $tbbahan['lokasi'] ?>">
            <label for="" class="form-label mb-1">Merek</label>
            <input type="text" class="form-control mb-2" name="merek" id="merek" value="<?= $tbbahan['merek'] ?>">
            <div class="input-group mb-2">
              <input type="hidden" class="form-control" name="kdjnbrge" id="kdjnbrge" value="<?= $tbbahan['kdjnbrg'] ?>">
            ...
            <div class="input-group mb-2">
              <input type="hidden" class="form-control" name="kdsatuane" id="kdsatuane" value="<?= $tbbahan['kdsatuan'] ?>">
            ...
            <div class="input-group mb-2">
              <input type="hidden" class="form-control" name="kdmovee" id="kdmovee" value="<?= $tbbahan['kdmove'] ?>">
            ...
            <div class="input-group mb-2">
              <input type="hidden" class="form-control" name="kddiscounte" id="kddiscounte" value="<?= $tbbahan['kddiscount'] ?>">
          ...
          <div class="col-12 col-sm-6">
            ...
            <input type="number" class="form-control" name="harga_jual" id="harga_jual" value="<?= $tbbahan['harga_jual'] ?>">
            <label for="" class="form-label mb-1">Harga Beli</label>
            <input type="number" class="form-control" name="harga_beli" id="harga_beli" value="<?= $tbbahan['harga_beli'] ?>">
            ...
            <input type="number" class="form-control" name="stock" id="stock" step="any" value="<?= $tbbahan['stock'] ?>" readonly>
            <label for="" class="form-label mb-1">Stock Min</label>
            <input type="number" class="form-control" name="stock_min" id="stock_min" step="any" value="<?= $tbbahan['stock_min'] ?>">
            <label for="" class="form-label mb-1">Stock Mak</label>
            <input type="number" class="form-control" name="stock_mak" id="stock_mak" step="any" value="<?= $tbbahan['stock_mak'] ?>">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.tambahtbsatuan').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('tbbahan/tambahtbsatuan') ?>",
        dataType: "json",
        success: function(response) {
          $('.viewmodal1').html(response.data).show();
    ...
    $('.tambahtbmove').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('tbbahan/tambahtbmove') ?>",
        dataType: "json",
        success: function(response) {
          $('.viewmodal1').html(response.data).show();
    ...
    $('.tambahtbdisc').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('tbbahan/tambahtbdisc') ?>",
        dataType: "json",
        success: function(response) {
          $('.viewmodal1').html(response.data).show();
    ...
    $('.tambahtbnegara').click(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?= site_url('tbbahan/tambahtbnegara') ?>",
        dataType: "json",
        success: function(response) {
          $('.viewmodal1').html(response.data).show();
