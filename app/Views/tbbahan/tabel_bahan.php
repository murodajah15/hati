...
<div class="row">
  ...
  <div class="container mt-1">
    <!-- <table class="table table-bordered table-striped" id="tbl-bahan-data"> -->
    <table id="tbl-bahan-data" class="table table-striped" style="width:100%">
      <!-- <table class="table"> -->
      <thead>
        <tr>
...
<script>
  $(document).ready(function() {
    $('#tbl-bahan-data').DataTable({
      ...
      ajax: {
        url: '<?= site_url('/tbbahan/ajax-load-data') ?>',
        type: 'POST',
      },
      columns: [{
          data: null,
