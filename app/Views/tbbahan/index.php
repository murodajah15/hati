...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbbahan/table_bahan'); ?>",
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('tbbahan/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbbahan/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function hapus($id, $kode) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('tbbahan/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
