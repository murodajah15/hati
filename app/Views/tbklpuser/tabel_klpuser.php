<div class="row">
  ...
  <div class="container mt-1">
    ...
    <table id="tbl-klpuser-data" class="table table-striped" style="width:100%">
      <!-- <table class="table"> -->
      <thead>
        <tr>
          <th width="30">No.</th>
        ...
        <?php foreach ($tbklpuser as $k) : ?>
          <tr>
            ...
            <td width="120">
              ...
              <button type='Button' class='btn btn-danger btn-sm' onClick="hapus(`<?= $k['id'] ?>`, `<?= $k['kelompok'] ?>`)"><i class="fa fa-trash"></i></button>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
