      ...
      <div class="modal-body">
        <div class="row mb-2">
          <div class="col-12 col-sm-6">
            ...
            <input type="text" style="text-align:right;" class='form-control mb-2' name='penerimaan' id='penerimaan'>
            <div class="input-group">
              <div class="col-md-4">
            ...
            <input type="text" style="text-align:right;" class='form-control mb-2' name='total_penerimaan' id='total_penerimaan' readonly>
          </div>
          <div class="col-12 col-sm-6">
