...
?> <div class=" row">
  <div class="container fluid mt-2">
    ...
    <table id="tbl-rpenerimaankasir-data" class="table table-striped" style="width:100%">
      <thead>
        <tr>
          <th width="30">No.</th>
      ...
      <tbody>
        <?php $n = 1; ?>
        <?php foreach ($penerimaankasir as $k) : ?>
          <tr>
            ...
            <td><?= $k['nmcustomer']; ?></td>
            <td><?= $k['cara_bayar']; ?></td>
            <td style="text-align:right;"><?= number_format($k['total_penerimaan'], 0, ',', ','); ?></td>
          <?php endforeach; ?>
      </tbody>
    </table>
    <!-- </div> -->
