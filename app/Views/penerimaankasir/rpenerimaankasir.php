    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div class="input-group">
          ...
          <div class="col-md-1">
            <!-- <a href="" target="_blank" onclick="cetakrpenerimaankasir()">aaaa</a> -->
            <!-- <button class="btn btn-flat btn-success btn-sm mb-2 mt-2 btnrpenerimaankasir" onclick="cetakrpenerimaankasir()" type="button"><i class="fa fa-print"></i> Print</button> -->
          </div>
        </div>
        <div id="tabel_rpenerimaankasir"></div>
      </div>
    </div>
  </div>
</main>
...
<script>
  function cetakrpenerimaankasir() {
    ...
    var w = window.open('penerimaankasir/cetakrpenerimaankasir/' + tanggal1);
    $.ajax({
      type: "post",
      data: {
      ...
      // url: "<?= site_url('penerimaankasir/cetakrpenerimaankasir'); ?>",
  ...
  function reload_table() {
    ...
    ?>
    $(document).ready(function() {
      $('#tbl-rpenerimaankasir-data').DataTable();
    });
    ...
    $.ajax({
      ...
      url: "<?= site_url('penerimaankasir/table_rpenerimaankasir'); ?>",
      // data: {
      // id: $id
      // },
      beforeSend: function(f) {
        ...
        // alert('1');
        $('#tabel_rpenerimaankasir').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_rpenerimaankasir').html(data);
