  ...
  <div class="container-fluid" style="width:100%;height:100%;background:white;">
    <div class=" row">
      ...
      <table cellspacing="1" cellpadding="0" height="0">
        ...
        <tr>
          ...
          <td width="5" style="font-size:12px;">:</td>
          <td colspan="5" style="font-size:12px;"> <?= $penerimaankasir['nomor'] ?></td>
        <tr>
          <td style="font-size:12px;">Tanggal</td>
          <td width="5" style="font-size:12px;">:</td>
          <!-- <td colspan="5" style="font-size:12px;"> <?= $penerimaankasir['tanggal'] ?></td> -->
          <?php
          $date = date_create($penerimaankasir['tanggal']);
          ?>
          <td colspan="5" style="font-size:12px;"> <?= date_format($date, "d-m-Y"); ?></td>
        <tr>
          <td style="font-size:12px;">No. SPK</td>
          <td width="5" style="font-size:12px;">:</td>
          <td colspan="5" style="font-size:12px;"> <?= $penerimaankasir['nospk'] ?></td>
        <tr>
          <td style="font-size:12px;">Customer</td>
          <td width="5" style="font-size:12px;">:</td>
          <td colspan="5" style="font-size:12px;"> <?= $penerimaankasir['nmcustomer'] ?></td>
        <tr>
          <td style="font-size:12px;">Jumlah</td>
          <td style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <?= 'Rp. ' ?></td>
          <td style="font-size:12px;text-align:right;"> <?= number_format($penerimaankasir['penerimaan'], 0, ',', ',') ?></td>
        <tr>
          <td style="font-size:12px;">Bank Charger</td>
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <?= 'Rp. ' ?></td>
          <td style="font-size:12px;text-align:right;"> <?= number_format($penerimaankasir['bank_charge'], 0, ',', ',') ?></td>
        <tr>
          <td style="font-size:12px;">Total</td>
          <td width="5" style="font-size:12px;">:</td>
          <td style="font-size:12px;"> <?= 'Rp. ' ?></td>
          <td style="font-size:12px;text-align:right;"> <?= number_format($penerimaankasir['total_penerimaan'], 0, ',', ',') ?></td>
        <tr>
          <?php
          $terbilang = ucwords(terbilang($penerimaankasir['total_penerimaan']));
          ?>
    ...
    <div class=" row">
      ...
      <table cellspacing="1" cellpadding="0" height="1">
        ...
        <tr>
          <td rowspan="2" style="text-align:left"><i><?= $penerimaankasir['keterangan'] ?></i></td>
