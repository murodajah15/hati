      ...
      <div class="modal-body">
        <div class="row mb-2">
          <div class="col-12 col-sm-6">
            ...
            <div class="input-group">
              <div class="col-md-4">
                ...
                <input type='text' class='form-control mb-2' id="nomor" name="nomor" readonly style="width: 100%" value="<?= $penerimaankasir['nomor'] ?>" readonly>
              </div>
              <div class="col-md-4">
                <label for="nama" class="form-label mb-1">Tanggal (M-D-Y)</label>
                <input type="date" class='form-control mb-2' name='tanggal' id='tanggal' style="width: 100%" value="<?= $penerimaankasir['tanggal'] ?>" readonly>
              </div>
            </div>
            ...
            <input type="text" style="text-align:right;" class='form-control mb-2' name='penerimaan' id='penerimaan' value="<?= $penerimaankasir['penerimaan'] ?>" readonly>
            <div class="input-group">
              <div class="col-md-4">
                <label for="nama" class="form-label mb-1">Bank Charge %</label>
                <input type="text" step="any" style="text-align:right;" class='form-control mb-2' name='bank_charge_pr' id='bank_charge_pr' value="<?= $penerimaankasir['bank_charge_pr'] ?>" readonly>
              </div>
              <div class="col-md-8">
                <label for="nama" class="form-label mb-1">Bank Charge</label>
                <input type="text" style="text-align:right;" class='form-control mb-2' name='bank_charge' id='bank_charge' value="<?= $penerimaankasir['bank_charge'] ?>" readonly>
              </div>
            </div>
          ...
          <div class="col-12 col-sm-6">
            ...
            <input type="text" style="text-align:left;" class='form-control mb-2' name='pemegang_kartu' id='pemegang_kartu' value="<?= $penerimaankasir['pemegang_kartu'] ?>" readonly>
            <!-- <div class="input-group">
              <div class="col-md-12">
            ...
            <label for="nama" class="form-label mb-0">Jenis Kartu</label><br>
            <input type="text" class="form-control" name="nmjnkartu" id="nmjnkartu" value="<?= $penerimaankasir['nmjnkartu'] ?>" readonly>
            <div class="input-group">
              <div class="col-md-12">
                <label for="nama" class="form-label mb-0">Nomor Rekening / Tanggal Cek</label><br>
                <div class="input-group mb-2">
                  <div class="col-md-8">
                    <input type="text" class="form-control" placeholder="Nomor Rekening" name="norek" id="norek" value="<?= $penerimaankasir['norek'] ?>" readonly>
                  </div>
                  <div class="col-md-4">
                    <input type="date" class="form-control" class="form-control" name="tglcek" id="tglcek" value="<?= $penerimaankasir['tglcek'] ?>" readonly>
                  </div>
                </div>
              </div>
            </div>
            <div class="input-group">
              <div class="col-md-12">
                ...
                <div class="input-group mb-2">
                  <div class="col-md-8">
                    <input type="text" class="form-control" placeholder="Nomor Cek" name="nocek" id="nocek" value="<?= $penerimaankasir['nocek'] ?>" readonly>
                  </div>
                  <div class="col-md-4">
                    <input type="date" class="form-control" class="form-control" name="tgljttempocek" id="tgljttempocek" value="<?= $penerimaankasir['tgljttempocek'] ?>" readonly>
                  </div>
                </div>
              </div>
            </div>
            <label for="nama" class="form-label mb-1">Keterangan</label>
            <textarea rows=3 class='form-control mb-2' name='keterangan' id='keterangan' readonly><?= $penerimaankasir['keterangan'] ?></textarea>
          </div>
