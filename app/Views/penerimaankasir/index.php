  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div id="tabel_penerimaankasir"></div>
      </div>
    </div>
</main>
...
<div class="viewmodalpenerimaankasir" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('penerimaankasir/table_penerimaankasir'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_penerimaankasir').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_penerimaankasir').html(data);
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('penerimaankasir/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('penerimaankasir/modaldetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailpenerimaankasir($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('wo/detailpenerimaankasir') ?>",
      dataType: "json",
      data: {
        id: $id
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modaldetail_penerimaankasir').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function hapus_penerimaankasir($id) {
    swal({
  ...
  function detail_penerimaankasir($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('penerimaankasir/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit_penerimaankasir($id) {
    $.ajax({
      type: "post",
  ...
  function formdetailpenerimaankasir($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailpenerimaankasir') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function modalpenerimaankasir($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('penerimaankasir/modalpenerimaankasir') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modalpenerimaankasir').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function proses_penerimaankasir($id) {
    swal({
  ...
  function unproses_penerimaankasir($id) {
    swal({
  ...
  function cetak_penerimaankasir($id) {
    // swal({
