...
<div class="row">
  <div class="container-fluid mt-2">
    ...
    <div class="container mt-2">
      ...
      <!-- <table class="table table-bordered table-striped" id="tbl-supplier-data"> -->
      <table id="tbl-supplier-data" class="table table-striped" style="width:100%">
        <!-- <table class="table"> -->
        <thead>
          <tr>
            <th width="30">#</th>
...
<script>
  $(document).ready(function() {
    $('#tbl-supplier-data').DataTable({
      ...
      ajax: {
        url: '<?= site_url('/tbsupplier/ajax-load-data') ?>',
        type: 'POST',
      },
      columns: [{
          data: null,
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('tbsupplier/formtambah') ?>",
      dataType: "json",
