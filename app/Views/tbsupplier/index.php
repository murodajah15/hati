...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('tbsupplier/table_supplier'); ?>",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbsupplier/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailmobil($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('tbsupplier/detailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbsupplier/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbsupplier/";
          $.ajax({
            url: "<?php echo site_url('tbsupplier/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function formdetailmobil($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('tbsupplier/formdetailmobil') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailmobil1($id) {
    $.get("tbsupplier/formdetailmobil", {
      id: $id
    }, function(data) {
      $("#tabel_supplier").html(data);
    });
  ...
  function carinopolisi() {
    $.ajax({
      url: "<?= site_url('tbsupplier/cari_nopolisi') ?>",
      dataType: "json",
      success: function(response) {
