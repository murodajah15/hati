    ...
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/tbopl/";
          $.ajax({
            url: "<?php echo site_url('tbopl/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
