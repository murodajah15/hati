...
<div class="row">
  ...
  <div class="container mt-1">
    <!-- <table class="table table-bordered table-striped" id="tbl-opl-data"> -->
    <table id="tbl-opl-data" class="table table-striped" style="width:100%">
      <!-- <table class="table"> -->
      <thead>
        <tr>
...
<script>
  $(document).ready(function() {
    $('#tbl-opl-data').DataTable({
      ...
      ajax: {
        url: '<?= site_url('/tbopl/ajax-load-data') ?>',
        type: 'POST',
      },
      columns: [{
          data: null,
