  ...
  <div class="container-fluid px-4">
    ...
    <div class="card mb-2 animate__animated animate__lightSpeedInLeft">
      ...
      <div class="card-body">
        ...
        <div id="tabel_approvmemodir"></div>
      </div>
    </div>
</main>
...
<div class="viewmodalapprovmemodir" style="display: none;"></div>
...
<script>
  ...
  function reload_table() {
    ...
    $.ajax({
      url: "<?= site_url('approvmemodir/table_approvmemodir'); ?>",
      beforeSend: function(f) {
        $('.btnreload').attr('disable', 'disabled')
        $('.btnreload').html('<i class="fa fa-spin fa-spinner"></i>')
        // alert('1');
        $('#tabel_approvmemodir').html('<center>Loading Table ...</center>');
      },
      success: function(data) {
        // alert(data);
        $('#tabel_approvmemodir').html(data);
  ...
  $('.tomboltambah').click(function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?= site_url('approvmemodir/formtambah') ?>",
      dataType: "json",
  ...
  function detail($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('approvmemodir/modaldetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function detailapprovmemodir($id) {
    $.ajax({
      type: "get",
      url: "<?= site_url('wo/detailapprovmemodir') ?>",
      dataType: "json",
      data: {
        id: $id
      },
      success: function(response) {
        if (response.sukses) {
          $('.viewmodal').html(response.sukses).show();
          $('#modaldetail_approvmemodir').modal('show');
        }
      },
      error: function(xhr, ajaxOptions, thrownError) {
        alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
  ...
  function hapus_approvmemodir($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $href = "/wo/";
          $.ajax({
            url: "<?php echo site_url('approvmemodir/hapus') ?>/" + $id,
            type: "POST",
            dataType: "JSON",
            success: function(data) {
  ...
  function detail_approvmemodir($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('approvmemodir/formdetail') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function edit_approvmemodir($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('approvmemodir/formedit') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function formdetailapprovmemodir($id) {
    $.ajax({
      type: "post",
      url: "<?= site_url('wo/formdetailapprovmemodir') ?>",
      dataType: "json",
      data: {
        id: $id
      },
  ...
  function modalapprovmemodir($id) {
    $.ajax({
      type: "POST",
      url: "<?= site_url('approvmemodir/modalapprovmemodir') ?>",
      dataType: "json",
      data: {
        id: $id,
      },
  ...
  function proses_approvmemodir($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('approvmemodir/proses') ?>/" + $id,
            data: {
              id: $id,
            },
            type: "POST",
  ...
  function unproses_approvmemodir($id) {
    swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
            url: "<?php echo site_url('approvmemodir/unproses') ?>/" + $id,
            data: {
              id: $id,
            },
            type: "POST",
  ...
  function cetak_approvmemodir($id) {
    // swal({
