      ...
      <div class="modal-body">
        <div class="row mb-2">
          ...
          <div class="col-12 col-sm-6">
            ...
            <label for="nama" class="form-label mb-1">Keterangan Approval</label>
            <textarea rows=3 class='form-control mb-2' name='ket_approv_sm' id='ket_approv_dir' readonly><?= $pengajuandiscount['ket_approv_dir'] ?></textarea>
          </div>
