...
class DashboardController extends Controller
{
  ...
  public function index(Request $request) //: View
  {
    ...
    $data = [
      ...
      'submenu1' => '',
      'title' => 'Home',
      'userdtlmenu' => $userdtl, //Userdtl::join('tbmodule', 'userdtl.cmodule', '=', 'tbmodule.cmodule')->where('userdtl.pakai', '1')->where('username', $username)->orderBy('userdtl.nurut')->get(),
      // ->where('userdtl.pakai', '1')->where('username', $username)->where('tbmodule.cmainmenu', 'Y')->orderBy('userdtl.nurut')->get(),      
