...
class TbleasingModel extends Model
{
  protected $table      = 'tbleasing';
  ...
  public function getleasing($id = false)
  {
    if ($id == false) {
      return $this->findAll();
    }
  ...
  {
    $builder = $this->db->table("tbleasing");
