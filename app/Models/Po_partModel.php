...
class Po_partModel extends Model
{
  ...
  protected $allowedFields = [
    'nopo', 'tanggal', 'kdsupplier', 'nmsupplier', 'jnsorder', 'reference', 'biaya1', 'nbiaya1', 'biaya2', 'nbiaya2', 'biaya3', 'total_biaya', 'catatan',
    'subtotal', 'totalsmt', 'ppn', 'rp_ppn', 'materai', 'total',  'user', 'close', 'part_shop',
  ];
