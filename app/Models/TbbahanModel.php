...
class TbbahanModel extends Model
{
  protected $table      = 'tbbahan';
  ...
  public function getkdbahan($kode = false)
  {
    if ($kode == false) {
      return $this->findAll();
    }
  ...
  public function getnmbahan($nama = false)
  {
    if ($nama == false) {
      return $this->findAll();
    }
