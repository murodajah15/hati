      ...
      if (!$valid) {
        ...
        if ($data) {
          ...
          $simpandata = [
            ...
            'jenis' => 'PART',
            'qty' => str_replace(",", "", $this->request->getVar('qtypart')),
            'harga' => preg_replace("/[^a-zA-Z0-9]/", "", $this->request->getVar('hargapart')),
            'pr_discount' => str_replace(",", "", $this->request->getVar('pr_discountpart')),
