...
class Approvmemosm extends BaseController
{
  ...
  public function ajaxLoadData()
  {
    ...
    $data = $this->pengajuandiscountModel->where('valid', 'Y')->where('status_approv_spv', 'SETUJUI')->tampilData($request, $katakunci, $start, $length);
  ...
  public function table_approvmemosm()
  {
    $model = new pengajuandiscountModel();
    $data['title'] = 'memombr';
    echo view('approvmemosm/tabel_approvmemosm', $data);
  }
  ...
  public function formdetail()
  {
    if ($this->request->isAjax()) {
      ...
      $msg = [
        'sukses' => view('Approvmemosm/modaldetail', $data)
      ];
