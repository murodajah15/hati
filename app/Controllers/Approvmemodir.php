...
class Approvmemodir extends BaseController
{
  protected $tbcustomerModel, $memombrModel, $woModel, $tbmobilModel, $tbmerekModel, $tbmodelModel, $tbtipeModel, $tbwarnaModel, $tbjenisModel, $tbagamaModel,
    $tbasuransiModel, $tbleasingModel, $tbsalesModel, $memombrdModel, $pengajuandiscountModel, $penerimaankasirModel;
  ...
  public function ajaxLoadData()
  {
    ...
    $data = $this->pengajuandiscountModel->where('valid', 'Y')->where('status_approv_sm', 'SETUJUI')->tampilData($request, $katakunci, $start, $length);
  ...
  public function table_approvmemodir()
  {
    $model = new pengajuandiscountModel();
    $data['title'] = 'memombr';
    echo view('approvmemodir/tabel_approvmemodir', $data);
  }
  ...
  public function formdetail()
  {
    if ($this->request->isAjax()) {
      ...
      $msg = [
        'sukses' => view('Approvmemodir/modaldetail', $data)
      ];
  ...
  public function hapus($id)
  {
    ...
    $nomemombr = $rowmemombr['nomemo'];
    // $rowjasa = $this->memombrjasaModel->getnomemombr($nomemombr);
